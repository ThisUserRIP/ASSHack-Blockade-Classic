...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit3(const char* label, float col[3], bool* rainbow, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], bool* rainbow, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker3(const char* label, float col[3], bool* rainbow, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], bool* rainbow, ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
