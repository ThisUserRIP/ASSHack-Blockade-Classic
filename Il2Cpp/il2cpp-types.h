...
typedef struct Il2CppObjectBase Il2CppObjectBase;
...
{
    const Il2CppImage* image; //00
    void* gc_desc;            //04
    const char* name;         //08
    const char* namespaze;    //12
    Il2CppType byval_arg;     //16
    Il2CppType this_arg;      //24
    Il2CppClass* element_class; //32
    Il2CppClass* castClass;   //36
    Il2CppClass* declaringType; //40
    Il2CppClass* parent;      //44
    Il2CppGenericClass *generic_class; //48
    const Il2CppTypeDefinition* typeDefinition; //52
    const Il2CppInteropData* interopData; //56
    Il2CppClass* klass;       //60
    FieldInfo* fields;        //64
    const EventInfo* events;  //68
    const PropertyInfo* properties; //72
    const MethodInfo** methods; //76
    Il2CppClass** nestedTypes; //80
    Il2CppClass** implementedInterfaces; //84
    Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets; //88
    void* static_fields;       //92
    const Il2CppRGCTXData* rgctx_data;
