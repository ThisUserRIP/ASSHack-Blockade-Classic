...
namespace Mono_Security::Mono::Security { struct PKCS7_EncryptedData; };
...
namespace Mono_Security::Mono::Security::Cryptography { struct PKCS8_PrivateKeyInfo; };
...
namespace Mono_Security::Mono::Security::X509
{
	struct PKCS12 : mscorlib::System::Object
	{
		...
		Mono_Security::Mono::Security::X509::X509CertificateCollection* _certs;
		...
		Mono_Security::Mono::Security::X509::X509CertificateCollection* get_Certificates();
		...
		IL2CPP::Array<uint8_t>* Decrypt(Mono_Security::Mono::Security::PKCS7_EncryptedData* ed);
		...
		void AddPrivateKey(Mono_Security::Mono::Security::Cryptography::PKCS8_PrivateKeyInfo* pki);
		void ReadSafeBag(Mono_Security::Mono::Security::ASN1* safeBag);
		Mono_Security::Mono::Security::ASN1* CertificateSafeBag(Mono_Security::Mono::Security::X509::X509Certificate* x509, mscorlib::System::Collections::IDictionary* attributes);
		...
		Mono_Security::Mono::Security::PKCS7_ContentInfo* EncryptedContentInfo(Mono_Security::Mono::Security::ASN1* safeBags, mscorlib::System::String* algorithmOid);
		void AddCertificate(Mono_Security::Mono::Security::X509::X509Certificate* cert);
		void AddCertificate(Mono_Security::Mono::Security::X509::X509Certificate* cert, mscorlib::System::Collections::IDictionary* attributes);
		void RemoveCertificate(Mono_Security::Mono::Security::X509::X509Certificate* cert);
		void RemoveCertificate(Mono_Security::Mono::Security::X509::X509Certificate* cert, mscorlib::System::Collections::IDictionary* attrs);
