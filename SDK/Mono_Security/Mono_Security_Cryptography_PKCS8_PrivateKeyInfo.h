...
namespace Mono_Security::Mono::Security::Cryptography { struct PKCS8; };
...
namespace Mono_Security::Mono::Security::Cryptography
{
	struct PKCS8_PrivateKeyInfo : mscorlib::System::Object
	{
		...
		static IL2CPP::Array<uint8_t>* Encode(mscorlib::System::Security::Cryptography::RSA* rsa);
		...
		static IL2CPP::Array<uint8_t>* Encode(mscorlib::System::Security::Cryptography::DSA* dsa);
		static IL2CPP::Array<uint8_t>* Encode(mscorlib::System::Security::Cryptography::AsymmetricAlgorithm* aa);
	};
}
