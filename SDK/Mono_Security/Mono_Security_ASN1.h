...
namespace Mono_Security::Mono::Security
{
	struct ASN1 : mscorlib::System::Object
	{
		...
		Mono_Security::Mono::Security::ASN1* Add(Mono_Security::Mono::Security::ASN1* asn1);
		...
		Mono_Security::Mono::Security::ASN1* get_Item(int32_t index);
		Mono_Security::Mono::Security::ASN1* Element(int32_t index, uint8_t anTag);
