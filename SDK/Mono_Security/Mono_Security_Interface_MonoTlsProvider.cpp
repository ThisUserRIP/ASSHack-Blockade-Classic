...
IL2CPP::Il2CppClass* Mono_Security::Mono::Security::Interface::MonoTlsProvider::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Mono.Security.dll", "Mono.Security.Interface", "MonoTlsProvider");
	return il2cppclass;
}
mscorlib::System::Type* Mono_Security::Mono::Security::Interface::MonoTlsProvider::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Mono_Security::Mono::Security::Interface::MonoTlsProvider::_ctor()
{
...
mscorlib::System::Guid Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_ID()
{
...
mscorlib::System::String* Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_Name()
{
...
bool Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_SupportsSslStream()
{
...
bool Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_SupportsConnectionInfo()
{
...
bool Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_SupportsMonoExtensions()
{
...
System::System::Security::Authentication::SslProtocols Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_SupportedProtocols()
{
	...
	if (returnValue == nullptr)
	{
		System::System::Security::Authentication::SslProtocols ret;
		std::memset(&ret, 0, sizeof(System::System::Security::Authentication::SslProtocols));
		return ret;
	}
	return static_cast<System::System::Security::Authentication::SslProtocols>(*(System::System::Security::Authentication::SslProtocols*)il2cpp_object_unbox(returnValue));
}
Mono_Security::Mono::Security::Interface::IMonoSslStream* Mono_Security::Mono::Security::Interface::MonoTlsProvider::CreateSslStream(mscorlib::System::IO::Stream* innerStream, bool leaveInnerStreamOpen, Mono_Security::Mono::Security::Interface::MonoTlsSettings* settings)
{
...
Mono_Security::Mono::Security::Interface::IMonoSslStream* Mono_Security::Mono::Security::Interface::MonoTlsProvider::CreateSslStreamInternal(System::System::Net::Security::SslStream* sslStream, mscorlib::System::IO::Stream* innerStream, bool leaveInnerStreamOpen, Mono_Security::Mono::Security::Interface::MonoTlsSettings* settings)
{
...
bool Mono_Security::Mono::Security::Interface::MonoTlsProvider::get_SupportsCleanShutdown()
{
