...
namespace Mono_Security::Mono::Security::X509
{
	struct X501 : mscorlib::System::Object
	{
		...
		static mscorlib::System::String* ToString(Mono_Security::Mono::Security::ASN1* seq);
		static mscorlib::System::String* ToString(Mono_Security::Mono::Security::ASN1* seq, bool reversed, mscorlib::System::String* separator, bool quotes);
		static void AppendEntry(mscorlib::System::Text::StringBuilder* sb, Mono_Security::Mono::Security::ASN1* entry, bool quotes);
		static void _cctor();
	};
}
