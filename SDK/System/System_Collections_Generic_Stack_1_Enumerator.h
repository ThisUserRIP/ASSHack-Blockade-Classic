...
namespace System::System::Collections::Generic
{
	template <typename T> struct Stack_1_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System::Collections::Generic::Stack_1<T>::GetIl2CppClass(), "Enumerator")));
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.Stack`1<T>" });
