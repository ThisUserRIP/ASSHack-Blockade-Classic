...
{
	struct DesignerSerializerAttribute : mscorlib::System::Attribute
	{
		...
		void _ctor(mscorlib::System::String* serializerTypeName, mscorlib::System::String* baseSerializerTypeName);
