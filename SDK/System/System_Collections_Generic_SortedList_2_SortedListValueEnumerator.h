...
{
	template <typename TKey, typename TValue> struct SortedList_2_SortedListValueEnumerator : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System::Collections::Generic::SortedList_2<TKey, TValue>::GetIl2CppClass(), "SortedListValueEnumerator")));
