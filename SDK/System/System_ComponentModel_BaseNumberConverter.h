...
{
	struct BaseNumberConverter : System::ComponentModel::TypeConverter
	{
		...
		mscorlib::System::Exception* FromStringError(mscorlib::System::String* failedText, mscorlib::System::Exception* innerException);
		...
		bool CanConvertTo(System::ComponentModel::ITypeDescriptorContext* context, mscorlib::System::Type* t);
		void _ctor();
	};
}
