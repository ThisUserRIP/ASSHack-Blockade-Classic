...
#include "..\mscorlib\System_Runtime_CompilerServices_TaskAwaiter.h"
...
{
	struct WebRequestStream__WriteRequestAsync_d__36
	{
		...
		mscorlib::System::Runtime::CompilerServices::TaskAwaiter __u__2;
		void MoveNext();
