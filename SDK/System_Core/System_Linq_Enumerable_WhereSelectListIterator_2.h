...
{
	template <typename TSource, typename TResult> struct Enumerable_WhereSelectListIterator_2 : System_Core::System::Linq::Enumerable_Iterator_1<TResult>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System_Core::System::Linq::Enumerable::GetIl2CppClass(), "WhereSelectListIterator`2")));
		...
		void _ctor(mscorlib::System::Collections::Generic::List_1<TSource>* source, mscorlib::System::Func_2<TSource, mscorlib::System::Boolean>* predicate, mscorlib::System::Func_2<TSource, TResult>* selector)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.List`1<TSource>", "System.Func`2<TSource,System.Boolean>", "System.Func`2<TSource,TResult>" });
