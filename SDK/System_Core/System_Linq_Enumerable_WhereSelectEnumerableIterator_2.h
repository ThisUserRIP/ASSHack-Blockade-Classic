...
{
	template <typename TSource, typename TResult> struct Enumerable_WhereSelectEnumerableIterator_2 : System_Core::System::Linq::Enumerable_Iterator_1<TResult>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System_Core::System::Linq::Enumerable::GetIl2CppClass(), "WhereSelectEnumerableIterator`2")));
		...
		mscorlib::System::Collections::Generic::IEnumerator_1<TSource>* enumerator;
		void _ctor(mscorlib::System::Collections::Generic::IEnumerable_1<TSource>* source, mscorlib::System::Func_2<TSource, mscorlib::System::Boolean>* predicate, mscorlib::System::Func_2<TSource, TResult>* selector)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.IEnumerable`1<TSource>", "System.Func`2<TSource,System.Boolean>", "System.Func`2<TSource,TResult>" });
