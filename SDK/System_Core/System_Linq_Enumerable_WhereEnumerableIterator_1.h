...
{
	template <typename TSource> struct Enumerable_WhereEnumerableIterator_1 : System_Core::System::Linq::Enumerable_Iterator_1<TSource>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System_Core::System::Linq::Enumerable::GetIl2CppClass(), "WhereEnumerableIterator`1")));
		...
		void _ctor(mscorlib::System::Collections::Generic::IEnumerable_1<TSource>* source, mscorlib::System::Func_2<TSource, mscorlib::System::Boolean>* predicate)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.IEnumerable`1<TSource>", "System.Func`2<TSource,System.Boolean>" });
