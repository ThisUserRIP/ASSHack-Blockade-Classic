...
namespace System_Core::System::Collections::Generic
{
	template <typename T> struct HashSet_1_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(System_Core::System::Collections::Generic::HashSet_1<T>::GetIl2CppClass(), "Enumerator")));
		...
		System_Core::System::Collections::Generic::HashSet_1<T>* _set;
		int32_t _index;
		int32_t _version;
		T _current;
		void _ctor(System_Core::System::Collections::Generic::HashSet_1<T>* set)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.HashSet`1<T>" });
