...
{
	struct Filter : System_Xml::MS::Internal::Xml::XPath::AstNode
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		System_Xml::MS::Internal::Xml::XPath::AstNode* input;
		System_Xml::MS::Internal::Xml::XPath::AstNode* condition;
		void _ctor(System_Xml::MS::Internal::Xml::XPath::AstNode* input, System_Xml::MS::Internal::Xml::XPath::AstNode* condition);
