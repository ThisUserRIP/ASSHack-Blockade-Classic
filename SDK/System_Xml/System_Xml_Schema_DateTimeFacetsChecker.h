...
{
	struct DateTimeFacetsChecker : System_Xml::System::Xml::Schema::FacetsChecker
	{
		...
		bool MatchEnumeration(mscorlib::System::DateTime value, mscorlib::System::Collections::ArrayList* enumeration, System_Xml::System::Xml::Schema::XmlSchemaDatatype* datatype);
		void _ctor();
	};
}
