...
{
	struct Ucs4Decoder : mscorlib::System::Text::Decoder
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		IL2CPP::Array<uint8_t>* lastBytes;
		int32_t lastBytesCount;
		int32_t GetCharCount(IL2CPP::Array<uint8_t>* bytes, int32_t index, int32_t count);
		int32_t GetFullChars(IL2CPP::Array<uint8_t>* bytes, int32_t byteIndex, int32_t byteCount, IL2CPP::Array<wchar_t>* chars, int32_t charIndex);
		...
		void Ucs4ToUTF16(uint32_t code, IL2CPP::Array<wchar_t>* chars, int32_t charIndex);
		void _ctor();
	};
}
