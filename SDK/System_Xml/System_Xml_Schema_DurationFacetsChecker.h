...
{
	struct DurationFacetsChecker : System_Xml::System::Xml::Schema::FacetsChecker
	{
		...
		bool MatchEnumeration(mscorlib::System::TimeSpan value, mscorlib::System::Collections::ArrayList* enumeration);
		void _ctor();
	};
}
