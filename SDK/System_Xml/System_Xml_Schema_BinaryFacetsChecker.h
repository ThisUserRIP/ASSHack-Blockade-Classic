...
{
	struct BinaryFacetsChecker : System_Xml::System::Xml::Schema::FacetsChecker
	{
		...
		bool MatchEnumeration(IL2CPP::Array<uint8_t>* value, mscorlib::System::Collections::ArrayList* enumeration, System_Xml::System::Xml::Schema::XmlSchemaDatatype* datatype);
		void _ctor();
	};
}
