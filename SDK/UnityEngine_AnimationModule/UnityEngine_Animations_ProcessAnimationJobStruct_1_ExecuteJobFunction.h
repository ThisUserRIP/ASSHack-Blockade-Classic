...
namespace UnityEngine_AnimationModule::UnityEngine::Animations { template <typename T> struct ProcessAnimationJobStruct_1; };
...
{
	template <typename T> struct ProcessAnimationJobStruct_1_ExecuteJobFunction : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(UnityEngine_AnimationModule::UnityEngine::Animations::ProcessAnimationJobStruct_1<T>::GetIl2CppClass(), "ExecuteJobFunction")));
		...
		void Invoke(T& data, intptr_t animationStreamPtr, intptr_t unusedPtr, UnityEngine_CoreModule::Unity::Jobs::LowLevel::Unsafe::JobRanges& ranges, int32_t jobIndex)
		{
		...
		mscorlib::System::IAsyncResult* BeginInvoke(T& data, intptr_t animationStreamPtr, intptr_t unusedPtr, UnityEngine_CoreModule::Unity::Jobs::LowLevel::Unsafe::JobRanges& ranges, int32_t jobIndex, mscorlib::System::AsyncCallback* callback, mscorlib::System::Object* object)
		{
