...
namespace UnityEngine_AnimationModule::UnityEngine { struct AnimatorOverrideController; };
...
{
	struct AnimatorOverrideController_OnOverrideControllerDirtyCallback : mscorlib::System::MulticastDelegate
	{
