...
{
	template <typename JSONRESPONSE, typename USERRESPONSEDELEGATETYPE> struct NetworkMatch__ProcessMatchResponse_d__26_2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			IL2CPP::Array<mscorlib::System::Type*>* arrayType = new IL2CPP::Array<mscorlib::System::Type*>();
			arrayType->max_length = 2;
			arrayType->vector[0] = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(JSONRESPONSE::GetIl2CppClass()));
			arrayType->vector[1] = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(USERRESPONSEDELEGATETYPE::GetIl2CppClass()));
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(UnityEngine_UNETModule::UnityEngine::Networking::Match::NetworkMatch::GetIl2CppClass(), "<ProcessMatchResponse>d__26`2")));
		...
		UnityEngine_UnityWebRequestModule::UnityEngine::Networking::UnityWebRequest* client;
		UnityEngine_UNETModule::UnityEngine::Networking::Match::NetworkMatch_InternalResponseDelegate_2<JSONRESPONSE, USERRESPONSEDELEGATETYPE>* internalCallback;
		USERRESPONSEDELEGATETYPE userCallback;
		UnityEngine_UNETModule::UnityEngine::Networking::Match::NetworkMatch* __4__this;
		JSONRESPONSE _jsonInterface_5__1;
		mscorlib::System::ArgumentException* _exception_5__2;
