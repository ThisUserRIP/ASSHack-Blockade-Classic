...
{
	struct ShortcutExtensions___c__DisplayClass28_0 : mscorlib::System::Object
	{
		...
		void _ctor();
		UnityEngine_CoreModule::UnityEngine::Vector4 _DOVector_b__0();
		void _DOVector_b__1(UnityEngine_CoreModule::UnityEngine::Vector4 x);
	};
}
