...
{
	struct ShortcutExtensions___c__DisplayClass70_0 : mscorlib::System::Object
	{
		...
		void _ctor();
		UnityEngine_CoreModule::UnityEngine::Vector3 _DOBlendableMoveBy_b__0();
		void _DOBlendableMoveBy_b__1(UnityEngine_CoreModule::UnityEngine::Vector3 x);
	};
}
