...
{
	template <typename T> struct DOGetter_1 : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("DOTween.dll", "DG.Tweening.Core", "DOGetter`1")));
