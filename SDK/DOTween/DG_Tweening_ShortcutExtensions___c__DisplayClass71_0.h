...
{
	struct ShortcutExtensions___c__DisplayClass71_0 : mscorlib::System::Object
	{
		...
		void _ctor();
		UnityEngine_CoreModule::UnityEngine::Vector3 _DOBlendableLocalMoveBy_b__0();
		void _DOBlendableLocalMoveBy_b__1(UnityEngine_CoreModule::UnityEngine::Vector3 x);
	};
}
