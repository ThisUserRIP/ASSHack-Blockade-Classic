...
{
	template <typename T> struct TweenCallback_1 : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("DOTween.dll", "DG.Tweening", "TweenCallback`1")));
