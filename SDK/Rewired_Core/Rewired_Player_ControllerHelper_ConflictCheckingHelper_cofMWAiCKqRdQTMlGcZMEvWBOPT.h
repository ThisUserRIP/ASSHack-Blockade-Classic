...
{
	template <typename T> struct Player_ControllerHelper_ConflictCheckingHelper_cofMWAiCKqRdQTMlGcZMEvWBOPT : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Player_ControllerHelper_ConflictCheckingHelper::GetIl2CppClass(), "cofMWAiCKqRdQTMlGcZMEvWBOPT")));
		...
		Rewired_Core::Rewired::InputMapCategory* LftIpyHnsjAsxgeMGjQYeBEUUdNO;
		int32_t vQrawvqlqdBJwDKbrKEVIdRifnJB;
		Rewired_Core::Rewired::ControllerMap* VqfgzpLafnpBwWTYQlIdUZnGGsT;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo ECWITESmeCYAKquiTpycGUslCAR;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo qGhNQqGXZJWplyDtJVNRmyiXEET;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* VJkyPRKMJNowlqNaVuLMYadBiFs;
		...
		void YtSnDNEiiVxxykNAYiBEhKGqSWW()
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "YtSnDNEiiVxxykNAYiBEhKGqSWW");
			Il2CppException* Il2CppException = nullptr;
