...
{
	struct Player_ControllerHelper_ConflictCheckingHelper_OjedQhhmlaNTTXdHGpMavhOGOwp : mscorlib::System::Object
	{
		...
		int32_t nRHkAMJanUoHjfVENrbtKZCisym;
		Rewired_Core::Rewired::CustomController* MRQCRvCUtTsIuMpvLCwYUkMwyEoi;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo GMzUDgwfDaFlRfMzfvuMCJFEouQd;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* EvZerHFVhKGJLgVtmTCOYghAmavW;
		...
		void qkGRqrLaUHDgRASeCusrqInbhFA();
	};
}
