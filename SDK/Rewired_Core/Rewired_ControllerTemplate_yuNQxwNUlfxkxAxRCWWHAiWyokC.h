...
{
	struct ControllerTemplate_yuNQxwNUlfxkxAxRCWWHAiWyokC : Rewired_Core::Rewired::ControllerTemplate_HWYeSWWlUMDAiOaBmaLRRmtVgPv
	{
		...
		struct StaticFields
		{
			...
			int32_t sNjXVtfAnvGqXhkavGFpvelIEfI;
		...
		Rewired_Core::Rewired::IControllerTemplateButton* get_press();
	};
}
