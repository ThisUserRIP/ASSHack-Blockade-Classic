...
{
	struct Player_ControllerHelper_MapHelper_aWkOuBUSUWesXfeXdrKsUPZBTOXl : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* CUkpiVGCQHGEDreqRfAQfBpbrdfV;
		int32_t oVIiDllJFOUtMhzoXZrFbvTBxTA;
		int32_t tlkhvUjPxpzsThtkjwEIRkejHWz;
		Rewired_Core::VuPCublfnEonOHYjswRWsBZbjCI* UhMEUJeOvomJOGaGEIkgUBnGWtDR;
		int32_t LGEURUUNMbxwsdfffAtrwmufUNx;
		int32_t VcpxBdCDRFgSmcNYYXydkeBzeZeA;
