...
{
	struct HardwareJoystickMap_Platform_SDL2_Base_MatchingCriteria_ElementCount : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_MatchingCriteria_Base_ElementCount_Base
	{
