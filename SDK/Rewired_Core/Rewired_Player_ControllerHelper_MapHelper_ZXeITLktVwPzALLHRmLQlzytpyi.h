...
{
	template <typename T> struct Player_ControllerHelper_MapHelper_ZXeITLktVwPzALLHRmLQlzytpyi : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Player_ControllerHelper_MapHelper::GetIl2CppClass(), "ZXeITLktVwPzALLHRmLQlzytpyi")));
		...
		Rewired_Core::Rewired::ControllerType cfTgUnoqMBdNMEcHwABBjUThAdTV;
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* vUoPSFVRAFtMvadGfvipOUhxZPE;
		int32_t PLaDOvdkMJytqjjvDmpJHSIyPlm;
		int32_t TRCcZTBgRkiOxbXSpzUievwFPBSD;
		Rewired_Core::VuPCublfnEonOHYjswRWsBZbjCI* ZGSdYbicNKTSSsjvmFfnNDxAGQj;
		int32_t qcHFXQTKygJsKDeJrhSYAytTBpVg;
		int32_t SFGnawIdNOzkbjgYnGJBcbFSrvqh;
		int32_t ZyXBkazgaaHCsEdOeOMKtNBZKJ;
		int32_t YPgtlQwRLTEOQCvsTNvgMzNJRfp;
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* iXxeNfZaoUlQqRbEeBeWKCBdclA;
		int32_t iPLKpCvaUbJenOmBWFHTGtLIiQNf;
		int32_t GuLYdteKizCrCDMbkvdTiugkPQEA;
		Rewired_Core::VuPCublfnEonOHYjswRWsBZbjCI* HwQOEQjDbfOjZZTDVmVuiMwKYL;
		int32_t hqDwYdZyllBRQOtdTZLEFokEfvw;
		int32_t ZBeHNOQdRZNqvpSmgznHVlwBmID;
		T cZJmrcMDcFIOXhBbvPvTGmecUYCR;
