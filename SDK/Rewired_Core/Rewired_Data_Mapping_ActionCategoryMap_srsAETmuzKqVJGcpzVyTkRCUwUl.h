...
{
	struct ActionCategoryMap_srsAETmuzKqVJGcpzVyTkRCUwUl : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t BLXOCZLUNCgPIURsBNVsBPlcDcw;
		int32_t VQDKxkXDrsgBgiFagWJRbTHVWMvQ;
		int32_t gsYcdgsVXKPCZInLZIsqDbJfYDK;
		Rewired_Core::Rewired::Data::Mapping::ActionCategoryMap* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		int32_t QJMJjIAkIPDJDNwHUTEOjNuRNuK;
		int32_t jRRhTynygsvWBGcYPQhBxrNedCP;
		int32_t nGRMbiaaHZrrqidmntwzNBJDJad;
		int32_t WJaznYxlUPfpynpiOfHUManoxqM;
		mscorlib::System::Collections::Generic::IEnumerator_1<mscorlib::System::Int32>* tkHcWLfYJjUdHkDzbmOYyHREjhps;
		...
		void txVeATbFuVCMTUPcTHmyPufxlteq();
	};
}
