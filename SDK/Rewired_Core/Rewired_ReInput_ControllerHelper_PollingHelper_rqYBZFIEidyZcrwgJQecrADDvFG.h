...
{
	struct ReInput_ControllerHelper_PollingHelper_rqYBZFIEidyZcrwgJQecrADDvFG : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Joystick>* ISXNeBRkSKLOxczCefuvaktzbmX;
		int32_t tlkhvUjPxpzsThtkjwEIRkejHWz;
		Rewired_Core::Rewired::ControllerPollingInfo bcZfglkiIAVcMJrRPbUUbtdASNrt;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* LAmNBoVKSFTyrIQbvLIaHvAiPLh;
		...
		void CtsbJRxztUFFrPDzuRMubgJsyPd();
	};
}
