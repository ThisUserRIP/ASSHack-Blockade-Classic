...
{
	struct ControllerMap_wvzAiJQFtJVsBoKnlPZGfGJvIRB : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::ControllerMap* wfAUDtDPRCYklfrgypFRPHBSJmN;
		Rewired_Core::Rewired::ControllerMap* nxibpAwrYuvAlpleCSURzRQIVz;
		bool NDxocnnrflICZFSWUtWTsvnZlPg;
		bool MRTCKGXDaXDKObmlBGfPGBKvnUNG;
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::ActionElementMap>* rzwSStYsXocSQevIZoEqNtmgidS;
		int32_t KuVdXraIPMhjwjzUeWEBLzpdHemu;
		int32_t ywcOQFJzfYyQwEyjvhMAOeDzvoM;
		Rewired_Core::Rewired::ActionElementMap* PdPVFUcvyBJCUizUUCjSkulahyw;
		int32_t ZrVuHhRxphEDXoPczCHokmzSGXn;
		Rewired_Core::Rewired::ActionElementMap* VdrdrJeOPCbEGwrfpLtPEnlyNXs;
