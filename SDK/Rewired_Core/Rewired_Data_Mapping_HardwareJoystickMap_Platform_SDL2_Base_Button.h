...
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_SDL2_Base_Element; };

namespace Rewired_Core::Rewired::Data::Mapping
{
	struct HardwareJoystickMap_Platform_SDL2_Base_Button : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Element
	{
		...
		void ImportVars(Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Element* source);
	};
}
