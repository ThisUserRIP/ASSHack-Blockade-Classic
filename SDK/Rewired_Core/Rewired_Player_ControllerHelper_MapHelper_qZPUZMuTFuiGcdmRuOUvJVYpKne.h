...
{
	struct Player_ControllerHelper_MapHelper_qZPUZMuTFuiGcdmRuOUvJVYpKne : mscorlib::System::Object
	{
		...
		int32_t aIdVXCIAZEAvmcvhhFIlqgPnWkY;
		int32_t ldmRqGHbmfIPBkciAzqzehWzNayS;
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* jPEMxTzVRGRIrZEhaCKWPUCaMpM;
		int32_t eUsoEYAIKClscrHrgUUbShIBcrE;
		int32_t FpuWUvKfaisSVEbsNnnUDNURxnc;
		Rewired_Core::VuPCublfnEonOHYjswRWsBZbjCI* lRjMjTJKOqjOJjejsfBUhHhjTXST;
		int32_t IdBemuXtdUEYKCOuDAnmcnljtyqe;
		int32_t EoglBvoJfvIFOIHReXBprAIpkXPr;
