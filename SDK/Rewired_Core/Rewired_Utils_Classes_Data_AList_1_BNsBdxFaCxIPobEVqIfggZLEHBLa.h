...
{
	template <typename T> struct AList_1_BNsBdxFaCxIPobEVqIfggZLEHBLa
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Utils::Classes::Data::AList_1<T>::GetIl2CppClass(), "BNsBdxFaCxIPobEVqIfggZLEHBLa")));
		...
		Rewired_Core::Rewired::Utils::Classes::Data::AList_1<T>* list;
		int32_t index;
		int32_t version;
		T current;
		void _ctor(Rewired_Core::Rewired::Utils::Classes::Data::AList_1<T>* list)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "Rewired.Utils.Classes.Data.AList`1<T>" });
