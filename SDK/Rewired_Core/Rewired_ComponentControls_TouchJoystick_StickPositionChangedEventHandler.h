...
{
	struct TouchJoystick_StickPositionChangedEventHandler : UnityEngine_CoreModule::UnityEngine::Events::UnityEvent_1<UnityEngine_CoreModule::UnityEngine::Vector2>
	{
