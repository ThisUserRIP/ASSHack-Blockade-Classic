...
{
	template <typename T> struct Player_ControllerHelper_MapHelper_vlKnlUXevpesZQgWdDPQrXziSbG : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Player_ControllerHelper_MapHelper::GetIl2CppClass(), "vlKnlUXevpesZQgWdDPQrXziSbG")));
		...
		Rewired_Core::Rewired::ControllerType vpCsQFPdPfICbEGyggnqFSvdiORP;
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* fLeKfQYMvUyeRssAOXYCYbSsCBd;
		int32_t bZkCiCJRhIBDzmvdEIbWhoyJpVlD;
		mscorlib::System::Collections::Generic::IList_1<T>* rNxGQyecAVfKTeJAraoNGFBecxN;
		int32_t RkQGuHdZLmcqzVmKfiJMgZHYsQx;
