...
{
	struct eCdfdxaCgKScksSvqjSZREluSubO_wtIgvuAZGNAubhnbbJFNRKvMOQXU : mscorlib::System::Object
	{
		...
		void _ctor();
		bool SUYqohklQpACykoQWiMEyTSTxRD(Rewired_Core::eCdfdxaCgKScksSvqjSZREluSubO_uEZzcHuAvFlwADFyCcVcbDMkdSh* A_1);
	};
}
