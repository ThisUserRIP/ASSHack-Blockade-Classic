...
{
	template <typename T> struct vhWAChkQtfbJbONWUAQVROGQdlbD_OPyAstbxuUderkkrRWECxRlApkp : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::vhWAChkQtfbJbONWUAQVROGQdlbD<T>::GetIl2CppClass(), "OPyAstbxuUderkkrRWECxRlApkp")));
