...
{
	struct ReInput_ControllerHelper_PollingHelper_WXrlSSoKyEBECFVgTfncEbpEHnw : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Joystick>* RsFEKHFpNgSENuHeGOIlSCJbXaZv;
		int32_t AcPkTDEtbCjGUTdRMwzPOhYzGtM;
		Rewired_Core::Rewired::ControllerPollingInfo lENVVtHRfkwrzUDosnbCyIHKIIZ;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* yGtaiuQYIkoFudsAxjvKNrVZUjY;
		...
		void CPysTwmJVXizQVCzCHWZLKqvBTq();
	};
}
