...
{
	struct ReInput_ControllerHelper_PollingHelper_KTjdIRzwLJbmQLsBDrgSmQpoiTp : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Joystick>* NKqWiVNfMjRzDsQGbNEGXjfPCs;
		int32_t OpeQqWKKtcIvpbEKThDkkZsskTi;
		Rewired_Core::Rewired::ControllerPollingInfo OOHFjROMRTxnIdfpRJQWlNvoPOB;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* bGSscOEJBsHvnfcdXSgsAHpmIoLj;
		...
		void VODTrDhOwDlmKZOXCFEOWeGAmkz();
	};
}
