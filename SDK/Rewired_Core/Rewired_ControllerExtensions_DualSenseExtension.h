...
namespace Rewired_Core::Rewired::ControllerExtensions { struct DualSenseExtension_dcSoOdatGwaOUatNykwBHflJQje; };
...
{
	struct DualSenseExtension : Rewired_Core::Rewired::Controller_Extension
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Rewired_Core::Rewired::ControllerExtensions::DualSenseExtension_dcSoOdatGwaOUatNykwBHflJQje* iRvUtWKJYFKiGcFQZzgNVetDeHZ;
		...
		void _ctor(Rewired_Core::Rewired::Drivers::Interfaces::IDriver_DualSense* driver);
		void _ctor(Rewired_Core::Rewired::ControllerExtensions::DualSenseExtension* source);
		...
		Rewired_Core::Rewired::ControllerExtensions::DualSenseMicrophoneLightMode get_microphoneLightMode();
		void set_microphoneLightMode(Rewired_Core::Rewired::ControllerExtensions::DualSenseMicrophoneLightMode value);
		Rewired_Core::Rewired::ControllerExtensions::DualSenseOtherLightBrightness get_otherLightBrightness();
		void set_otherLightBrightness(Rewired_Core::Rewired::ControllerExtensions::DualSenseOtherLightBrightness value);
		Rewired_Core::Rewired::ControllerExtensions::DualSensePlayerLightFlags get_playerLights();
		void set_playerLights(Rewired_Core::Rewired::ControllerExtensions::DualSensePlayerLightFlags value);
