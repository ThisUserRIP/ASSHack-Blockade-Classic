...
{
	struct eCdfdxaCgKScksSvqjSZREluSubO_fXhhTdumYRNrBuCEAPYJXMveJjo : mscorlib::System::Object
	{
		...
		void _ctor();
		bool xidGugtNPSltSYhIdbSzVbbCjqR(Rewired_Core::eCdfdxaCgKScksSvqjSZREluSubO_uEZzcHuAvFlwADFyCcVcbDMkdSh* A_1);
	};
}
