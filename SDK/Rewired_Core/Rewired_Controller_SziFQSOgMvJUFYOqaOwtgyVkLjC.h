...
{
	struct Controller_SziFQSOgMvJUFYOqaOwtgyVkLjC : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::Controller* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		int32_t oEAgkqJatPZZaEWtpKIPhMwDoIV;
		int32_t IdhhHECJqknTQjPTyEjACoDJmCuD;
