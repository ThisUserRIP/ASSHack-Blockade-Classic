...
{
	struct ActionCategoryMap_Entry_URrwVPqtHfypdomcrZwABfcHwQV : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::Data::Mapping::ActionCategoryMap_Entry* NyfwhqBNXDPdOSLBNnpiEtscIKX;
