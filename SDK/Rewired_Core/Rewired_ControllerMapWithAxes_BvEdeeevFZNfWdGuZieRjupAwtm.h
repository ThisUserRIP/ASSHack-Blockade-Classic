...
{
	struct ControllerMapWithAxes_BvEdeeevFZNfWdGuZieRjupAwtm : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::ActionElementMap* YwjvIjVuKZrJzKhhsNKTsTxpcCm;
		Rewired_Core::Rewired::ActionElementMap* jjLqQnuffOEowgJGSmdTQaIFfqqj;
		bool NDxocnnrflICZFSWUtWTsvnZlPg;
		bool MRTCKGXDaXDKObmlBGfPGBKvnUNG;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo CfFeqbtweyhUYtkfOCkdFfFMnAZM;
		int32_t NOYDUOhGujfNivOFsDkgzBjQirx;
		Rewired_Core::Rewired::ActionElementMap* SajkHppDsxXBfZJiufrldrEwqBN;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* eEEmFlnTRqnDqywcJWiNifUEiNC;
		...
		void JJRcUaCYALVpuEMivtLEeqIaAXk();
	};
}
