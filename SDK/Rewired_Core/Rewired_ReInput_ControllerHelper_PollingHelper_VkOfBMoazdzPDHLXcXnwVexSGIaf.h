...
{
	struct ReInput_ControllerHelper_PollingHelper_VkOfBMoazdzPDHLXcXnwVexSGIaf : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Joystick>* YiGobxUYXVhLemPEnFhmNjiUZET;
		int32_t tQvqSRSeAQuxMZCECUYiHEmfRQR;
		Rewired_Core::Rewired::ControllerPollingInfo UfdSyiUCFTQGPibPSZGiWmlLgJzF;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* sgNCRkYUABdevjXDwWlPmCgzPPJL;
		...
		void edoviOewdmQuIWHgoJAQFihCDfI();
	};
}
