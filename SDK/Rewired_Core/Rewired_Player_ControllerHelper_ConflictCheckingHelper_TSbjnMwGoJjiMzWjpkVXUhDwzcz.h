...
{
	struct Player_ControllerHelper_ConflictCheckingHelper_TSbjnMwGoJjiMzWjpkVXUhDwzcz : mscorlib::System::Object
	{
		...
		int32_t xDixLsQLCwVWLDhGBEwPNtKYpWn;
		Rewired_Core::Rewired::CustomController* ylESCuVYMyiphqvMwrItecfNIgJ;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo mKDeyAfYIlIyFvXiKEiceDuvImp;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* FusfOAsirPbVCRXzRYgRfNvfBfhE;
