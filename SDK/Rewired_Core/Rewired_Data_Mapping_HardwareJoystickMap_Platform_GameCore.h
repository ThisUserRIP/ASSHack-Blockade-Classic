...
{
	struct HardwareJoystickMap_Platform_GameCore : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base*>* variants;
		...
		static Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore* CreateDefaultMap(Rewired_Core::Rewired::BridgedControllerHWInfo* bridgedController);
		void _ctor();
	};
}
