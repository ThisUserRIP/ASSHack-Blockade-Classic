...
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_WindowsUWP_Base_MatchingCriteria_ElementCount; };
...
{
	struct HardwareJoystickMap_Platform_WindowsUWP_Base_MatchingCriteria : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_MatchingCriteria_Base
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t hatCount;
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_WindowsUWP_Base_MatchingCriteria_ElementCount*>* alternateElementCounts;
