...
{
	struct HardwareJoystickMap_Platform_SDL2_Base_Elements : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Elements_Base
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Axis*>* axes;
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Button*>* buttons;
		int32_t get_buttonCount();
		int32_t get_axisCount();
		Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Axis* GetAxis(int32_t axisIndex);
		mscorlib::System::Collections::Generic::IEnumerable_1<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Axis>* get_Axes();
		mscorlib::System::Collections::Generic::IEnumerable_1<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_SDL2_Base_Button>* get_Buttons();
