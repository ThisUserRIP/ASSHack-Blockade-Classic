...
{
	struct ReInput_ControllerHelper_PollingHelper_EPlwuIAlvXBMRCKlFdHvPbVLJZt : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Joystick>* MdUvWNHnEDpvPVrROpudDkqFYXk;
		int32_t gPEUdbSYFIoZQNvyFHNBoKfDCTRH;
		Rewired_Core::Rewired::ControllerPollingInfo lYVAsBaCgtaBgaiJiFPBShqCNkYx;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* yWdFSNimOdGbxONPTlxuQgimkPim;
		...
		void KkHBLrlctgcKfEVFlAJIjeZhLcuR();
	};
}
