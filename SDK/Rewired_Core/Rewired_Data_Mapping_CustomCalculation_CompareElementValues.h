...
{
	struct CustomCalculation_CompareElementValues : Rewired_Core::Rewired::Data::Mapping::CustomCalculation
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Rewired_Core::Rewired::Data::Mapping::CustomCalculation_CompareElementValues_ComparisonType _comparisonType;
		struct StaticFields
		{
