...
{
	struct eCdfdxaCgKScksSvqjSZREluSubO_FBeDuNasdHNGRCSDgOQawNRZXBUr : mscorlib::System::Object
	{
		...
		void _ctor();
		bool JTnFnYqEPrBVhNYrBjUKqFruBne(Rewired_Core::eCdfdxaCgKScksSvqjSZREluSubO_uEZzcHuAvFlwADFyCcVcbDMkdSh* A_1);
	};
}
