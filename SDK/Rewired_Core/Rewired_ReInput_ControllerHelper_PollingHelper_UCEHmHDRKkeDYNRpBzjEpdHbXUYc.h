...
{
	struct ReInput_ControllerHelper_PollingHelper_UCEHmHDRKkeDYNRpBzjEpdHbXUYc : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::CustomController>* EZZDIeWZCJtoOenUxUjkkYmHVKG;
		int32_t ZjKaEOghquXOaaDSHEfooemKHly;
		Rewired_Core::Rewired::ControllerPollingInfo npanVfjRsDKZunSHidoSyuaOdnt;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* ZVlzPXTFCVxEeifKMMWriUVZZMB;
		...
		void xrbuciDCZYTMANOaBJKJZLGIRWR();
	};
}
