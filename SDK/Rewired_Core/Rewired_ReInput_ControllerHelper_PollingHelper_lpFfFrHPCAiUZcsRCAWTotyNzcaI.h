...
{
	struct ReInput_ControllerHelper_PollingHelper_lpFfFrHPCAiUZcsRCAWTotyNzcaI : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::CustomController>* qBVcoebXLGTlrzwHOrxOgGCrnMN;
		int32_t efPUJfbdIIzzVVAUnaCyimHdINEn;
		Rewired_Core::Rewired::ControllerPollingInfo KGgpeEisUsFMMWCbWRLLxDKFsDY;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* qvasFBfhxVPWVTCItrUiSEwyxuY;
		...
		void muarbqrfKOEjpbLbixTdWsWBhBpg();
	};
}
