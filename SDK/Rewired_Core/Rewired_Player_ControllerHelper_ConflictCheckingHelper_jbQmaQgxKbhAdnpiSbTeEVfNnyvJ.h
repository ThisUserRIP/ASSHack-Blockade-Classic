...
{
	struct Player_ControllerHelper_ConflictCheckingHelper_jbQmaQgxKbhAdnpiSbTeEVfNnyvJ : mscorlib::System::Object
	{
		...
		int32_t agEFXNFQAeqGbSGBvWeUdZlbAzRr;
		Rewired_Core::Rewired::Joystick* XCLUreueFkLLkQiYiidoiNsImuU;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo GjtQmVNFASkGRAIPhiEAjPNrrfQ;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* cDQlvaUiZuGIuSIfaJYspELXhIi;
		...
		void yfhFfFnKqsawLchxaqBolrsuDSH();
	};
}
