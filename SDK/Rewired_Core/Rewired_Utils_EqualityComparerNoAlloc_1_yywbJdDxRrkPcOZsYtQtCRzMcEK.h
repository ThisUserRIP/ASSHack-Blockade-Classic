...
namespace Rewired_Core::Rewired::Utils { template <typename T> struct EqualityComparerNoAlloc_1_yywbJdDxRrkPcOZsYtQtCRzMcEK; };
...
{
	template <typename T> struct EqualityComparerNoAlloc_1_yywbJdDxRrkPcOZsYtQtCRzMcEK : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Utils::EqualityComparerNoAlloc_1<T>::GetIl2CppClass(), "yywbJdDxRrkPcOZsYtQtCRzMcEK")));
		...
		struct StaticFields
		{
			Rewired_Core::Rewired::Utils::EqualityComparerNoAlloc_1_yywbJdDxRrkPcOZsYtQtCRzMcEK<T>* urfmHgUocyipzfmMBBgefgsjZgZG;
		};
		static StaticFields* GetStaticFields() { return reinterpret_cast<StaticFields*>(GetIl2CppClass()->static_fields); }
		static Rewired_Core::Rewired::Utils::EqualityComparerNoAlloc_1_yywbJdDxRrkPcOZsYtQtCRzMcEK<T>* get_Default()
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "get_Default");
			Il2CppException* Il2CppException = nullptr;
			IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, nullptr, nullptr, &Il2CppException);
			Il2CppExceptionMessage(Il2CppException);
			return (Rewired_Core::Rewired::Utils::EqualityComparerNoAlloc_1_yywbJdDxRrkPcOZsYtQtCRzMcEK<T>*)returnValue;
		}
		bool Equals(int32_t x, int32_t y)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Equals", std::vector<std::string> { "System.Int32", "System.Int32" });
