...
{
	struct ReInput_ControllerHelper_ConflictCheckingHelper_RMueqLKuhoIfKaysTEArgSyDqIly : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::JoystickMap* GHleWYDmVYnBaqdjZrBOgVksEwXB;
		Rewired_Core::Rewired::JoystickMap* VosPZzbchBbJvfgBWDvySkjGkKbB;
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Player>* nDyXjVABgndJwHKTtRDgoZMEKhzk;
		int32_t kymrIEzPlTYTTVaRzbRywIicBZo;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo vwLPHmOWlZkdiQqTePsqIUUHhPJ;
		Rewired_Core::Rewired::ReInput_ControllerHelper_ConflictCheckingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* ynomsTafsTKuxYcIluGAOgSFwUf;
		...
		void utsnyfUrNevaECqcleUTUcrpgso();
	};
}
