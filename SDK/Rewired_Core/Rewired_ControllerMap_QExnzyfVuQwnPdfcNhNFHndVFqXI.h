...
{
	struct ControllerMap_QExnzyfVuQwnPdfcNhNFHndVFqXI : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::ElementAssignment UTmBjfUBQoWcszyOyQoSDDCiCeG;
		int32_t hhuSCKetbmVnvGWOJbhexeguZhW;
		Rewired_Core::Rewired::ActionElementMap* tPvzRHrlpeAABmpWKJALXPhwFlg;
