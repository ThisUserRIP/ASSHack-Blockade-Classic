...
{
	template <typename TKey, typename TValue> struct ADictionary_2_ValueCollection_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_ValueCollection<TKey, TValue>::GetIl2CppClass(), "Enumerator")));
		...
		TValue ZXvMbpzFoqCAGIhTcZYmutYTqlMC;
