...
{
	template <typename T> struct Player_ControllerHelper_ConflictCheckingHelper_IKfhCTPOdNfbYiRiVjFCicvRKNsB : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Player_ControllerHelper_ConflictCheckingHelper::GetIl2CppClass(), "IKfhCTPOdNfbYiRiVjFCicvRKNsB")));
		...
		Rewired_Core::Rewired::ControllerType fhoejNelLTVgRvWkgptzIJFhcYda;
		Rewired_Core::Rewired::ControllerType ezRxIbKnFodNUTZbCMNVjDZpcyC;
		int32_t sjwcfVrqpdNAbHTTEOLFXMIAylL;
		int32_t rDRIYUGOuFYSCPdtLpJDAcKJvzba;
		T ZKkWAjraafJGyzaCYrvVjaGAqIu;
		T ITgFfLFPMtQjfJKArwXjqUOnKJFD;
		Rewired_Core::Rewired::ActionElementMap* IwprpqWXjlIRuLFegKySvXQRrff;
		Rewired_Core::Rewired::ActionElementMap* mGNBZHhzpicvPCILANliCfPEgceV;
		...
		Rewired_Core::Rewired::InputMapCategory* BzqgKuFIRuIPRGKIJGPUvBCizwoh;
		int32_t aUiaSDamggEpnjcrCkMpjSMlwQNb;
		Rewired_Core::Rewired::ControllerMap* gEvjTzjTAnBvdamcgMfUaRxBfKGY;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo XjDEUirxCSbMwRTwMFSQFwJaPyWe;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo JdBqCmIVIwvqfYsbFoKMCKCpSZY;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* bhIuIljOTBEdYkpWyKvMWaPVdSsE;
		...
		void qRprODAdZvcYMzwFKiqBCJYMlbq()
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "qRprODAdZvcYMzwFKiqBCJYMlbq");
			Il2CppException* Il2CppException = nullptr;
