...
{
	struct Player_ControllerHelper_MapHelper_nYSSyhqXcTEEZYCNfHAJiUuLpPz : mscorlib::System::Object
	{
		...
		int32_t fsEurhEqnycYvQorbwMbDBHWwzs;
		int32_t TsblyEZSmRXqofaKlqxkKbOADWY;
		Rewired_Core::Rewired::Player_ControllerHelper_TZoNXevHUTdPPGNpVPmigLKtHbF* mAZHfBGoDxdMfJkyWMVDhLoxDHGn;
		int32_t tyfTJCjMLkAJGGbZDahBNgpwsEY;
		int32_t LtzBRivfpywakHgwZxUhgnZqCPB;
		Rewired_Core::VuPCublfnEonOHYjswRWsBZbjCI* UIqDyfDFhAoARQQXwpEVECqkMeI;
		int32_t QCyspecVthoPfnyUCveojVdWiBw;
		int32_t QRrhHWiJOyyiGitwJEIcmCPfGar;
		Rewired_Core::Rewired::ControllerMap* SMvYYVNEReGZvUOMiLajaWqGpFg;
