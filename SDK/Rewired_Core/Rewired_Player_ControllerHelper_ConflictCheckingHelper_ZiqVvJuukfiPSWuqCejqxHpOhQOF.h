...
{
	struct Player_ControllerHelper_ConflictCheckingHelper_ZiqVvJuukfiPSWuqCejqxHpOhQOF : mscorlib::System::Object
	{
		...
		int32_t NOYDUOhGujfNivOFsDkgzBjQirx;
		Rewired_Core::Rewired::Joystick* myGftthuYCgZndTUAoKKvBfRBzle;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo aPpuQdudyAwkrGDOokoDRQWyNNh;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* OcFBozhRXTavzcwGecNXEUgwBapY;
