...
{
	template <typename TKey, typename TValue> struct IndexedDictionary_2_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Utils::Classes::Data::IndexedDictionary_2<TKey, TValue>::GetIl2CppClass(), "Enumerator")));
		...
		void _ctor(Rewired_Core::Rewired::Utils::Classes::Data::IndexedDictionary_2<TKey, TValue>* dictionary, int32_t getEnumeratorRetType)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "Rewired.Utils.Classes.Data.IndexedDictionary`2<TKey,TValue>", "System.Int32" });
