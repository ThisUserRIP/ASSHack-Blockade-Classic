...
{
	struct ReInput_ControllerHelper_ConflictCheckingHelper_RjRGSRiVZQRSDHychndroEmNPyx : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Player>* FzJzilZCXoLzQHwRcRTyCQOhtyt;
		int32_t ScmdsNqCkXIydamyIaJEIteCyYPB;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo GyanJtucvIQNcevEKdghYlOEmSB;
		Rewired_Core::Rewired::ReInput_ControllerHelper_ConflictCheckingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* YLsFhpifTYNwGFowlshKjbjdxFI;
		...
		void fcQgtxymUYKUPWByYIDeMCLLhDc();
	};
}
