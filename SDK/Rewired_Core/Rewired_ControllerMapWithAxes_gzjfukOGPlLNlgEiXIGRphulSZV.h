...
{
	struct ControllerMapWithAxes_gzjfukOGPlLNlgEiXIGRphulSZV : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::ElementAssignmentConflictInfo qEFZIwEpPnCnGcVbPfpcqBhrgSvA;
		Rewired_Core::Rewired::ElementAssignment AjcrKcdFOBbgnGIrHPsKTPzwcXlG;
		int32_t hahlYQJeHFnzICGQtKSxHQdVAEG;
		Rewired_Core::Rewired::ActionElementMap* FEjViqAPyJiNwSbyTTmdcAPBHSD;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* UbpYAegsZCSQqeOWdWxSeXcsHQc;
		...
		void wlCRtQClasGiryFCavbQEUfrXDT();
	};
}
