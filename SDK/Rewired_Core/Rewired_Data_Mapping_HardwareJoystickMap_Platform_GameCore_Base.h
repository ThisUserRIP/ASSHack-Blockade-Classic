...
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_GameCore_Base_MatchingCriteria; };
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_GameCore_Base_Elements; };
...
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_GameCore_Base_Axis; };
namespace Rewired_Core::Rewired::Data::Mapping { struct HardwareJoystickMap_Platform_GameCore_Base_Button; };
...
{
	struct HardwareJoystickMap_Platform_GameCore_Base : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_Custom
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base_MatchingCriteria* matchingCriteria;
		Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base_Elements* elements;
		...
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base_Axis*>* get_Axes_orig();
		IL2CPP::Array<Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_GameCore_Base_Button*>* get_Buttons_orig();
		bool get_hasData();
		bool get_disabled();
		bool get_isAllowed();
