...
{
	struct HardwareJoystickMap_Platform_RawInput_Base_Button : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_RawOrDirectInput_Button_Base
	{
		...
		void ImportVars(Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_Platform_RawInput_Base_Button* source);
	};
}
