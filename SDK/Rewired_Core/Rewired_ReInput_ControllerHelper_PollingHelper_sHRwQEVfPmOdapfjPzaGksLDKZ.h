...
{
	struct ReInput_ControllerHelper_PollingHelper_sHRwQEVfPmOdapfjPzaGksLDKZ : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::CustomController>* FmIaHXjeQBaNHKffWamIEvhFsePf;
		int32_t SZjyrpHAOuEGDEhshnMjTuAIQwhG;
		Rewired_Core::Rewired::ControllerPollingInfo QLJgaDTIKHKBGpFPUVHlgPLPpOW;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* aFvioNjVzKbsOogSUOYVDkcTYcNJ;
		...
		void bnqZqfQTfFSeuUIYIJTaVXfFwel();
	};
}
