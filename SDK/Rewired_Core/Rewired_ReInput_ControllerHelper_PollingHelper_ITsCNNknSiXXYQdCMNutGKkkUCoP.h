...
{
	struct ReInput_ControllerHelper_PollingHelper_ITsCNNknSiXXYQdCMNutGKkkUCoP : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::CustomController>* ybIettIicPRPdWcuFdejErKHIMlK;
		int32_t YcgjiyESQqzCCdljyPIgeWUgmfGO;
		Rewired_Core::Rewired::ControllerPollingInfo fBGlMoFaphOMnNHiPHEOiZntlew;
		Rewired_Core::Rewired::ReInput_ControllerHelper_PollingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ControllerPollingInfo>* ypTuWBfEYyixXXcTUQdazLYIlKZ;
		...
		void JpnkrifeUErIYjBWKwojlElqZbq();
	};
}
