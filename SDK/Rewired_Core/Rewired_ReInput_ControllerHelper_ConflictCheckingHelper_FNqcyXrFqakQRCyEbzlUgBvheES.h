...
{
	struct ReInput_ControllerHelper_ConflictCheckingHelper_FNqcyXrFqakQRCyEbzlUgBvheES : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::KeyboardMap* iLmergdDCCtmawCfRafiAjFCMqAY;
		Rewired_Core::Rewired::KeyboardMap* bVTGFEEtKCcRfRWqTdFpiWqSFoq;
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Player>* zwUWrnPMmaFKkhSDhmTFcxkGwAg;
		int32_t uKbNqBjujjaEagjoTyrBBPEammk;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo HsiGALggMhtIkTKElAktddvGKVjW;
		Rewired_Core::Rewired::ReInput_ControllerHelper_ConflictCheckingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* BADCgcVKePbcSlPxHeUFuUQIGdP;
		...
		void QIzhFeYmsJfclLwNWnfGRMIxgLI();
	};
}
