...
{
	template <typename T> struct ReadOnlyArrayStruct_1
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Rewired_Core.dll", "Rewired.Utils.Classes.Data", "ReadOnlyArrayStruct`1")));
		...
		void _ctor(IL2CPP::Array<T>* array)
		{
