...
{
	template <typename TKey, typename TValue> struct IAddKeyValue_2
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Rewired_Core.dll", "Rewired.Utils.Interfaces", "IAddKeyValue`2")));
