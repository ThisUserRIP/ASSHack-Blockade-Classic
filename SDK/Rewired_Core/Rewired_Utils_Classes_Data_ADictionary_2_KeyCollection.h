...
namespace Rewired_Core::Rewired::Utils::Classes::Data { template <typename TKey, typename TValue> struct ADictionary_2_KeyCollection_Enumerator; };
...
{
	template <typename TKey, typename TValue> struct ADictionary_2_KeyCollection : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2<TKey, TValue>::GetIl2CppClass(), "KeyCollection")));
		...
		Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_KeyCollection_Enumerator<TKey, TValue> GetEnumerator()
		{
			...
			{
				Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_KeyCollection_Enumerator<TKey, TValue> ret;
				std::memset(&ret, 0, sizeof(Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_KeyCollection_Enumerator<TKey, TValue>));
				return ret;
			}
			return static_cast<Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_KeyCollection_Enumerator<TKey, TValue>>(*(Rewired_Core::Rewired::Utils::Classes::Data::ADictionary_2_KeyCollection_Enumerator<TKey, TValue>*)il2cpp_object_unbox(returnValue));
		}
