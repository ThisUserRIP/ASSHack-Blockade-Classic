...
{
	struct ReInput_ControllerHelper_ConflictCheckingHelper_EQMHNuBnOtbKJrRXmRbJLdYrsca : mscorlib::System::Object
	{
		...
		int32_t LwEPxfogKyegbzkaGUYXDfsUhIT;
		int32_t rtWfhHcVgWskILBCSlJXColCPFvP;
		int32_t sgaYvQFbIMHxAFATolrtHMjCSot;
		Rewired_Core::Rewired::CustomControllerMap* YFnYaIbugKwStceQBfkVEumlcwJD;
		Rewired_Core::Rewired::CustomControllerMap* pyAxTqDlJtgdmJIDHxjsCipGUar;
		Rewired_Core::Rewired::ActionElementMap* QdDFlUaTPDlaZfGFRChlGooxKKPC;
		Rewired_Core::Rewired::ActionElementMap* ERJzXZkyvnGevodJrAqbBSiygEr;
		...
		bool DZJqTHZNxLRjfeuTBplKGHEqZeh;
		bool MIIaSvsPRjKzeVwFChkqWJnyGrDE;
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Player>* QdozDBWEzwAHqkMwEwjGjLJqgDTu;
		int32_t eLxInsyKmPIZWDEBZhhykkzbRtC;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo wMjxOucfPkDJyUOvLdvQANZoXPKs;
		Rewired_Core::Rewired::ReInput_ControllerHelper_ConflictCheckingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* QMwbtohehXFQjfeOpjXiGdsGBcgB;
		...
		void VWXQuUUsQMeDZIODGqTNNyhpxeC();
	};
}
