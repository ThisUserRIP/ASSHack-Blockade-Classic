...
{
	struct ReInput_ControllerHelper_ConflictCheckingHelper_qFoNwVuxKimFcwHlqDlLrvxSOZE : mscorlib::System::Object
	{
		...
		mscorlib::System::Collections::Generic::IList_1<Rewired_Core::Rewired::Player>* pbbqLJbZCvLcDBLxnnuMzXEqUjM;
		int32_t JHMBHWpoXVcGpfpEBTpAhmEfUph;
		Rewired_Core::Rewired::ElementAssignmentConflictInfo vbRBmHbfroQCsOjUluHfUwRvLEwA;
		Rewired_Core::Rewired::ReInput_ControllerHelper_ConflictCheckingHelper* NyfwhqBNXDPdOSLBNnpiEtscIKX;
		mscorlib::System::Collections::Generic::IEnumerator_1<Rewired_Core::Rewired::ElementAssignmentConflictInfo>* YXFgIWECOOcKOlcjYDIrdSSoPJQ;
		...
		void cUuVYrVOjklnkwrObSQHzkJUMFT();
	};
}
