...
{
	struct eCdfdxaCgKScksSvqjSZREluSubO_XNdygsuDeLBOgjGTJwJamPeDXNwJ : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::InputActionEventType SQKvzFKoRWTwQaawgWVLaufmvwj;
		int32_t tEMgFkDxlxXUMXvptLslJksJXos;
		void _ctor();
		bool oCmNGISDobjIoVykPAbJgEEdvgp(Rewired_Core::eCdfdxaCgKScksSvqjSZREluSubO_uEZzcHuAvFlwADFyCcVcbDMkdSh* A_1);
	};
}
