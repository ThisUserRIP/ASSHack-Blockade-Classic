...
{
	struct HardwareJoystickMap_Platform_Fallback_Base_MatchingCriteria : Rewired_Core::Rewired::Data::Mapping::HardwareJoystickMap_MatchingCriteria_Base
	{
		...
		mscorlib::System::String* matchUnityVersion_min;
		mscorlib::System::String* matchUnityVersion_max;
		bool matchSysVersion;
		mscorlib::System::String* matchSysVersion_min;
		mscorlib::System::String* matchSysVersion_max;
		bool get_hasData();
		bool get_isAllowed();
