...
{
	struct eCdfdxaCgKScksSvqjSZREluSubO_OyuESviVpcurrTEaYSatnPhGBwzZ : mscorlib::System::Object
	{
		...
		void _ctor();
		bool HUdQIaOnfPbswRsiljlXGfKDghXd(Rewired_Core::eCdfdxaCgKScksSvqjSZREluSubO_uEZzcHuAvFlwADFyCcVcbDMkdSh* A_1);
	};
}
