...
{
	struct ControllerTemplate_GqiOxxudSaHqMMqooNvSNCYFzIC : Rewired_Core::Rewired::ControllerTemplate_fghSFsBtglMMLettCXZVfOngWoP
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		struct StaticFields
		{
			int32_t VpieZcVTeHRZMsjLEKrGBaaHQLU;
