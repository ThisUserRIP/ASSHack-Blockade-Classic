...
{
	struct ControllerWithAxes_nWBQUhghpvXRtJBLqfOVGEzyfAU : mscorlib::System::Object
	{
		...
		Rewired_Core::Rewired::Pole sSiGrykAAaXmleZHahjxLSEzqUP;
		int32_t cKetTAFllCwZEgOdYWcKZsWIJZU;
