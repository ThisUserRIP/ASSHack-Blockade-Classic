...
{
	template <typename K, typename V> struct SerializedDictionary_2 : mscorlib::System::Collections::Generic::Dictionary_2<K, V>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Unity.RenderPipelines.Core.Runtime.dll", "UnityEngine.Rendering", "SerializedDictionary`2")));
