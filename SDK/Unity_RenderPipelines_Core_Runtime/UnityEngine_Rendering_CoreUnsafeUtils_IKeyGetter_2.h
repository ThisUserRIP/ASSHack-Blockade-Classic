...
{
	template <typename TValue, typename TKey> struct CoreUnsafeUtils_IKeyGetter_2
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::CoreUnsafeUtils::GetIl2CppClass(), "IKeyGetter`2")));
		...
		TKey* Get(TValue& v)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Get", std::vector<std::string> { GetGenericTypeName<TValue>() + (std::string)"&" });
