...
namespace Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering { struct DebugUI_BoolField; };
...
{
	struct DebugUIHandlerToggle : Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::UI::DebugUIHandlerWidget
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		UnityEngine_UI::UnityEngine::UI::Text* nameLabel;
		UnityEngine_UI::UnityEngine::UI::Toggle* valueToggle;
		UnityEngine_UI::UnityEngine::UI::Image* checkmarkImage;
		Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::DebugUI_BoolField* m_Field;
