...
{
	struct DebugUIHandlerToggleHistory : Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::UI::DebugUIHandlerToggle
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		IL2CPP::Array<UnityEngine_UI::UnityEngine::UI::Toggle*>* historyToggles;
		struct StaticFields
		{
			float xDecal;
		};
