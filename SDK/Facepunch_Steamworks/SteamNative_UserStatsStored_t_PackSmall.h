...
{
	struct UserStatsStored_t_PackSmall
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		uint64_t GameID;
		Facepunch_Steamworks::SteamNative::Result Result;
		static Facepunch_Steamworks::SteamNative::UserStatsStored_t op_Implicit(Facepunch_Steamworks::SteamNative::UserStatsStored_t_PackSmall d);
	};
}
