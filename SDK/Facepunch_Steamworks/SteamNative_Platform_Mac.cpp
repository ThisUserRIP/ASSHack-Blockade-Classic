...
IL2CPP::Il2CppClass* Facepunch_Steamworks::SteamNative::Platform_Mac::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIl2CppNestedType(Facepunch_Steamworks::SteamNative::Platform::GetIl2CppClass(), "Mac");
	return il2cppclass;
}
mscorlib::System::Type* Facepunch_Steamworks::SteamNative::Platform_Mac::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
bool Facepunch_Steamworks::SteamNative::Platform_Mac::get_IsValid()
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::_ctor(intptr_t pointer)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::Dispose()
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamUser(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamGameServer(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamFriends(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamUtils(int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamMatchmaking(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamMatchmakingServers(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamUserStats(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamGameServerStats(int32_t hSteamuser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamApps(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamNetworking(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamRemoteStorage(int32_t hSteamuser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamScreenshots(int32_t hSteamuser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamHTTP(int32_t hSteamuser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamUGC(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamAppList(int32_t hSteamUser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamClient_GetISteamInventory(int32_t hSteamuser, int32_t hSteamPipe, mscorlib::System::String* pchVersion)
{
...
Facepunch_Steamworks::SteamNative::CSteamID Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUser_GetSteamID()
{
...
Facepunch_Steamworks::SteamNative::VoiceResult Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUser_GetAvailableVoice(uint32_t& pcbCompressed, uint32_t& pcbUncompressed_Deprecated, uint32_t nUncompressedVoiceDesiredSampleRate_Deprecated)
{
...
uint32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUser_GetVoiceOptimalSampleRate()
{
...
Facepunch_Steamworks::SteamNative::HAuthTicket Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUser_GetAuthSessionTicket(intptr_t pTicket, int32_t cbMaxTicket, uint32_t& pcbTicket)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUser_CancelAuthTicket(uint32_t hAuthTicket)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetPersonaName()
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendCount(int32_t iFriendFlags)
{
...
Facepunch_Steamworks::SteamNative::CSteamID Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendByIndex(int32_t iFriend, int32_t iFriendFlags)
{
...
Facepunch_Steamworks::SteamNative::FriendRelationship Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendRelationship(uint64_t steamIDFriend)
{
...
Facepunch_Steamworks::SteamNative::PersonaState Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendPersonaState(uint64_t steamIDFriend)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendPersonaName(uint64_t steamIDFriend)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendGamePlayed(uint64_t steamIDFriend, Facepunch_Steamworks::SteamNative::FriendGameInfo_t& pFriendGameInfo)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetSmallFriendAvatar(uint64_t steamIDFriend)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetMediumFriendAvatar(uint64_t steamIDFriend)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetLargeFriendAvatar(uint64_t steamIDFriend)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_RequestUserInformation(uint64_t steamIDUser, bool bRequireNameOnly)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_RequestFriendRichPresence(uint64_t steamIDFriend)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamFriends_GetFriendMessage(uint64_t steamIDFriend, int32_t iMessageID, intptr_t pvData, int32_t cubData, Facepunch_Steamworks::SteamNative::ChatEntryType& peChatEntryType)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUtils_GetImageSize(int32_t iImage, uint32_t& pnWidth, uint32_t& pnHeight)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUtils_GetImageRGBA(int32_t iImage, intptr_t pubDest, int32_t nDestBufferSize)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUtils_IsAPICallCompleted(uint64_t hSteamAPICall, bool& pbFailed)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUtils_GetAPICallResult(uint64_t hSteamAPICall, intptr_t pCallback, int32_t cubCallback, int32_t iCallbackExpected, bool& pbFailed)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamMatchmaking_GetFavoriteGameCount()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamMatchmaking_GetFavoriteGame(int32_t iGame, uint32_t& pnAppID, uint32_t& pnIP, uint16_t& pnConnPort, uint16_t& pnQueryPort, uint32_t& punFlags, uint32_t& pRTime32LastPlayedOnServer)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_RequestCurrentStats()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_GetAchievementAndUnlockTime(mscorlib::System::String* pchName, bool& pbAchieved, uint32_t& punUnlockTime)
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_GetAchievementIcon(mscorlib::System::String* pchName)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_GetAchievementDisplayAttribute(mscorlib::System::String* pchName, mscorlib::System::String* pchKey)
{
...
uint32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_GetNumAchievements()
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamUserStats_GetAchievementName(uint32_t iAchievement)
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetCurrentGameLanguage()
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetAvailableGameLanguages()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetCurrentBetaName(mscorlib::System::Text::StringBuilder* pchName, int32_t cchNameBufferSize)
{
...
uint32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetAppInstallDir(uint32_t appID, mscorlib::System::Text::StringBuilder* pchFolder, uint32_t cchFolderBufferSize)
{
...
Facepunch_Steamworks::SteamNative::CSteamID Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetAppOwner()
{
...
int32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamApps_GetAppBuildId()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamNetworking_IsP2PPacketAvailable(uint32_t& pcubMsgSize, int32_t nChannel)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamNetworking_ReadP2PPacket(intptr_t pubDest, uint32_t cubDest, uint32_t& pcubMsgSize, uint64_t& psteamIDRemote, int32_t nChannel)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamNetworking_AcceptP2PSessionWithUser(uint64_t steamIDRemote)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamNetworking_CloseP2PSessionWithUser(uint64_t steamIDRemote)
{
...
Facepunch_Steamworks::SteamNative::Result Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetResultStatus(int32_t resultHandle)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetResultItems(int32_t resultHandle, intptr_t pOutItemsArray, uint32_t& punOutItemsArraySize)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetResultItemProperty(int32_t resultHandle, uint32_t unItemIndex, mscorlib::System::String* pchPropertyName, mscorlib::System::Text::StringBuilder* pchValueBuffer, uint32_t& punValueBufferSizeOut)
{
...
uint32_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetResultTimestamp(int32_t resultHandle)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_DestroyResult(int32_t resultHandle)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetAllItems(int32_t& pResultHandle)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_SerializeResult(int32_t resultHandle, intptr_t pOutBuffer, uint32_t& punOutBufferSize)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_LoadItemDefinitions()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetItemDefinitionIDs(intptr_t pItemDefIDs, uint32_t& punItemDefIDsArraySize)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetItemDefinitionProperty(int32_t iDefinition, mscorlib::System::String* pchPropertyName, mscorlib::System::Text::StringBuilder* pchValueBuffer, uint32_t& punValueBufferSizeOut)
{
...
Facepunch_Steamworks::SteamNative::SteamAPICall_t Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_RequestPrices()
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::ISteamInventory_GetItemPrice(int32_t iDefinition, uint64_t& pPrice)
{
...
bool Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_Init()
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_RunCallbacks()
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_RegisterCallback(intptr_t pCallback, int32_t callback)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_UnregisterCallback(intptr_t pCallback)
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_Shutdown()
{
...
void Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamGameServer_Shutdown()
{
...
Facepunch_Steamworks::SteamNative::HSteamUser Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_GetHSteamUser()
{
...
Facepunch_Steamworks::SteamNative::HSteamPipe Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamAPI_GetHSteamPipe()
{
...
intptr_t Facepunch_Steamworks::SteamNative::Platform_Mac::SteamApi_SteamInternal_CreateInterface(mscorlib::System::String* version)
{
