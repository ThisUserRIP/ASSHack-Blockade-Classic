...
{
	struct UserStatsReceived_t_PackSmall
	{
		...
		static Facepunch_Steamworks::SteamNative::UserStatsReceived_t op_Implicit(Facepunch_Steamworks::SteamNative::UserStatsReceived_t_PackSmall d);
	};
}
