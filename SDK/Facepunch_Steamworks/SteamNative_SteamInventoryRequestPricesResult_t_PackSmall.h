...
{
	struct SteamInventoryRequestPricesResult_t_PackSmall
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Facepunch_Steamworks::SteamNative::Result Result;
		mscorlib::System::String* Currency;
		static Facepunch_Steamworks::SteamNative::SteamInventoryRequestPricesResult_t op_Implicit(Facepunch_Steamworks::SteamNative::SteamInventoryRequestPricesResult_t_PackSmall d);
	};
}
