...
namespace Facepunch_Steamworks::SteamNative { struct Platform_Linux32; };
...
namespace Facepunch_Steamworks::SteamNative { struct FriendGameInfo_t_PackSmall; };
namespace Facepunch_Steamworks::SteamNative { struct FriendGameInfo_t_PackSmall; };
...
{
	struct Platform_Linux32_Native : mscorlib::System::Object
	{
		...
		static bool SteamAPI_ISteamFriends_GetFriendGamePlayed(intptr_t ISteamFriends, uint64_t steamIDFriend, Facepunch_Steamworks::SteamNative::FriendGameInfo_t_PackSmall& pFriendGameInfo);
