...
{
	struct Curve25519FieldElement : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::AbstractFpFieldElement
	{
		...
		struct StaticFields
		{
			...
			IL2CPP::Array<uint32_t>* PRECOMP_POW2;
		};
		...
		bool Equals(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement* other);
		int32_t GetHashCode();
		static void _cctor();
	};
}
