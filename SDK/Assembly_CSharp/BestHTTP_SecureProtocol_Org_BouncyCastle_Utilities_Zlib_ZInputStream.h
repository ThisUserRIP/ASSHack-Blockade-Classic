...
{
	struct ZInputStream : mscorlib::System::IO::Stream
	{
		...
		void _ctor(mscorlib::System::IO::Stream* input, bool nowrap);
		void _ctor(mscorlib::System::IO::Stream* input, Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Utilities::Zlib::ZStream* z);
		void _ctor(mscorlib::System::IO::Stream* input, int32_t level);
		void _ctor(mscorlib::System::IO::Stream* input, int32_t level, bool nowrap);
		bool get_CanRead();
		bool get_CanSeek();
		bool get_CanWrite();
		void Close();
