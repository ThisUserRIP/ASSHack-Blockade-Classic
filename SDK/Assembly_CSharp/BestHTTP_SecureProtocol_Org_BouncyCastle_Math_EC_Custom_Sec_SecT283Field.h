...
{
	struct SecT283Field : mscorlib::System::Object
	{
		...
		static void Reduce37(IL2CPP::Array<uint64_t>* z, int32_t zOff);
		...
		static void ImplMulw(uint64_t x, uint64_t y, IL2CPP::Array<uint64_t>* z, int32_t zOff);
