...
{
	template <typename T1, typename T2> struct HubConnection___c__DisplayClass73_0_2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::SignalRCore::HubConnection::GetIl2CppClass(), "<>c__DisplayClass73_0`2")));
		...
		mscorlib::System::Action_2<T1, T2>* callback;
		void _ctor()
		{
