...
{
	template <typename T> struct LocalizeTarget_1 : Assembly_CSharp::I2::Loc::ILocalizeTarget
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Assembly-CSharp.dll", "I2.Loc", "LocalizeTarget`1")));
