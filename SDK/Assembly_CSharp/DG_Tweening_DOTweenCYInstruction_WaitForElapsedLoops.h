...
{
	struct DOTweenCYInstruction_WaitForElapsedLoops : UnityEngine_CoreModule::UnityEngine::CustomYieldInstruction
	{
		...
		void _ctor(DOTween::DG::Tweening::Tween* tween, int32_t elapsedLoops);
	};
}
