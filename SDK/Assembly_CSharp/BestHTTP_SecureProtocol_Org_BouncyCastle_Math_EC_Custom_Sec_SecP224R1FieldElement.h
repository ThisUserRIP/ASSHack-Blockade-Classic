...
{
	struct SecP224R1FieldElement : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::AbstractFpFieldElement
	{
		...
		bool Equals(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224R1FieldElement* other);
		int32_t GetHashCode();
		static bool IsSquare(IL2CPP::Array<uint32_t>* x);
		static void RM(IL2CPP::Array<uint32_t>* nc, IL2CPP::Array<uint32_t>* d0, IL2CPP::Array<uint32_t>* e0, IL2CPP::Array<uint32_t>* d1, IL2CPP::Array<uint32_t>* e1, IL2CPP::Array<uint32_t>* f1, IL2CPP::Array<uint32_t>* t);
		static void RP(IL2CPP::Array<uint32_t>* nc, IL2CPP::Array<uint32_t>* d1, IL2CPP::Array<uint32_t>* e1, IL2CPP::Array<uint32_t>* f1, IL2CPP::Array<uint32_t>* t);
		static void RS(IL2CPP::Array<uint32_t>* d, IL2CPP::Array<uint32_t>* e, IL2CPP::Array<uint32_t>* f, IL2CPP::Array<uint32_t>* t);
		static bool TrySqrt(IL2CPP::Array<uint32_t>* nc, IL2CPP::Array<uint32_t>* r, IL2CPP::Array<uint32_t>* t);
		static void _cctor();
	};
}
