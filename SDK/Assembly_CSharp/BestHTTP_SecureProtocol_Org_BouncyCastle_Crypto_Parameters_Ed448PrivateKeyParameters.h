...
{
	struct Ed448PrivateKeyParameters : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::AsymmetricKeyParameter
	{
		...
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* GeneratePublicKey();
		void Sign(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_Algorithm algorithm, Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* publicKey, IL2CPP::Array<uint8_t>* ctx, IL2CPP::Array<uint8_t>* msg, int32_t msgOff, int32_t msgLen, IL2CPP::Array<uint8_t>* sig, int32_t sigOff);
		static void _cctor();
	};
}
