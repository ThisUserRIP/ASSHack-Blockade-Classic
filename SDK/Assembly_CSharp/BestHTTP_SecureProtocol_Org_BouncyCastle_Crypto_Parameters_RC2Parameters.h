...
{
	struct RC2Parameters : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::KeyParameter
	{
		...
		void _ctor(IL2CPP::Array<uint8_t>* key, int32_t bits);
		void _ctor(IL2CPP::Array<uint8_t>* key, int32_t keyOff, int32_t keyLen, int32_t bits);
