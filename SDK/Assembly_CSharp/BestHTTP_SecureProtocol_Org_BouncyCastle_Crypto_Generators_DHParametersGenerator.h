...
{
	struct DHParametersGenerator : mscorlib::System::Object
	{
		...
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters();
		void _ctor();
	};
}
