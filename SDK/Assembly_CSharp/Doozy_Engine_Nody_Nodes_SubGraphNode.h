...
{
	struct SubGraphNode : Assembly_CSharp::Doozy::Engine::Nody::Models::Node
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Assembly_CSharp::Doozy::Engine::Nody::Models::Graph* m_subGraph;
		bool ErrorNoGraphReferenced;
		bool ErrorReferencedGraphIsNotSubGraph;
		Assembly_CSharp::Doozy::Engine::Nody::Models::Graph* get_SubGraph();
		void OnCreate();
