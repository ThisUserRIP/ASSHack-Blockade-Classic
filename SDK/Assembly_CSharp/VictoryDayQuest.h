...
namespace Assembly_CSharp { struct VDMission; };
...
{
	struct VictoryDayQuest : UnityEngine_CoreModule::UnityEngine::MonoBehaviour
	{
		...
		struct StaticFields
		{
			...
			mscorlib::System::Collections::Generic::Dictionary_2<mscorlib::System::Int32, Assembly_CSharp::VDMission>* MissionsList;
