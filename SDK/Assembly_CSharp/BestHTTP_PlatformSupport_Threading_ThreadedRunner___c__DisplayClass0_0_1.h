...
{
	template <typename T> struct ThreadedRunner___c__DisplayClass0_0_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::PlatformSupport::Threading::ThreadedRunner::GetIl2CppClass(), "<>c__DisplayClass0_0`1")));
		...
		mscorlib::System::Action_1<T>* job;
		T param;
		void _ctor()
		{
