...
{
	struct Blake2sDigest : mscorlib::System::Object
	{
		...
		int32_t bufferPos;
		IL2CPP::Array<uint32_t>* internalState;
		IL2CPP::Array<uint32_t>* chainValue;
		uint32_t t0;
		uint32_t t1;
		uint32_t f0;
		struct StaticFields
		{
			IL2CPP::Array<uint32_t>* blake2s_IV;
			IL2CPP::Array<uint8_t>* blake2s_sigma;
			int32_t ROUNDS;
			int32_t BLOCK_LENGTH_BYTES;
		};
		static StaticFields* GetStaticFields() { return reinterpret_cast<StaticFields*>(GetIl2CppClass()->static_fields); }
		void _ctor();
		void _ctor(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Digests::Blake2sDigest* digest);
		void _ctor(int32_t digestBits);
		void _ctor(IL2CPP::Array<uint8_t>* key);
		void _ctor(IL2CPP::Array<uint8_t>* key, int32_t digestBytes, IL2CPP::Array<uint8_t>* salt, IL2CPP::Array<uint8_t>* personalization);
		void Init();
