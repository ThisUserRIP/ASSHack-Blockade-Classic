...
{
	template <typename V, typename T> struct vp_Attempt_1_Tryer_1 : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::vp_Attempt_1<V>::GetIl2CppClass(), "Tryer`1")));
