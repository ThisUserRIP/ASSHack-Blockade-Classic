...
IL2CPP::Il2CppClass* Assembly_CSharp::CactusBlock::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Assembly-CSharp.dll", "", "CactusBlock");
	return il2cppclass;
}
mscorlib::System::Type* Assembly_CSharp::CactusBlock::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Assembly_CSharp::CactusBlock::Init(Assembly_CSharp::BlockSet* blockSet)
{
...
UnityEngine_CoreModule::UnityEngine::Rect Assembly_CSharp::CactusBlock::GetPreviewFace()
{
...
UnityEngine_CoreModule::UnityEngine::Rect Assembly_CSharp::CactusBlock::GetTopFace()
{
...
IL2CPP::Array<UnityEngine_CoreModule::UnityEngine::Vector2>* Assembly_CSharp::CactusBlock::GetFaceUV(Assembly_CSharp::CubeFace face)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetFaceUV", std::vector<std::string> { "CubeFace" });
	intptr_t* params = new intptr_t[1];
...
void Assembly_CSharp::CactusBlock::Build(Assembly_CSharp::Vector3i localPos, Assembly_CSharp::Vector3i worldPos, Assembly_CSharp::MeshBuilder* mesh, bool onlyLight)
{
...
Assembly_CSharp::MeshBuilder* Assembly_CSharp::CactusBlock::Build()
{
...
bool Assembly_CSharp::CactusBlock::IsSolid()
{
...
void Assembly_CSharp::CactusBlock::_ctor()
{
