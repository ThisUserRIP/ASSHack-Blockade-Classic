...
{
	struct TerrainClear : mscorlib::System::Object
	{
		...
		void GenerateChunk(int32_t cx, int32_t cy, int32_t cz);
		mscorlib::System::Collections::IEnumerator* Generate(int32_t cx, int32_t cz);
