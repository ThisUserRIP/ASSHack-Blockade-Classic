...
{
	struct SecP160R2FieldElement : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::AbstractFpFieldElement
	{
		...
		bool Equals(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement* other);
		int32_t GetHashCode();
		static void _cctor();
	};
}
