...
{
	struct MaxBytesExceededException : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::CryptoException
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		void _ctor();
		void _ctor(mscorlib::System::String* message);
		void _ctor(mscorlib::System::String* message, mscorlib::System::Exception* e);
	};
}
