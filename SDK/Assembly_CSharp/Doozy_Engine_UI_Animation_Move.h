...
{
	struct Move : mscorlib::System::Object
	{
		...
		Assembly_CSharp::Doozy::Engine::UI::Animation::Direction Direction;
		UnityEngine_CoreModule::UnityEngine::Vector3 CustomPosition;
		...
		Assembly_CSharp::Doozy::Engine::UI::Animation::Move* Copy();
	};
}
