...
{
	struct HSL : mscorlib::System::Object
	{
		...
		float s;
		float l;
		void _ctor(float H, float S, float L);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL* Copy();
		UnityEngine_CoreModule::UnityEngine::Color Color(float alpha);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::RGB* ToRGB();
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL* Validate();
