...
{
	struct UIButtonBehavior : mscorlib::System::Object
	{
		...
		Assembly_CSharp::Doozy::Engine::UI::Base::UIAction* OnTrigger;
		...
		Assembly_CSharp::Doozy::Engine::UI::UIButtonBehaviorType m_behaviorType;
		struct StaticFields
		{
			...
			float ON_DOUBLE_CLICK_DISABLE_INTERVAL;
			float ON_LONG_CLICK_DISABLE_INTERVAL;
			float ON_POINTER_DOWN_DISABLE_INTERVAL;
			float ON_POINTER_ENTER_DISABLE_INTERVAL;
			float ON_POINTER_EXIT_DISABLE_INTERVAL;
			float ON_POINTER_UP_DISABLE_INTERVAL;
		};
		...
		Assembly_CSharp::Doozy::Engine::UI::UIButtonBehaviorType get_BehaviorType();
		...
		void _ctor(Assembly_CSharp::Doozy::Engine::UI::UIButtonBehaviorType behaviorType, bool enabled);
		float GetAnimationTotalDuration();
		void LoadPreset();
		void LoadPreset(mscorlib::System::String* presetCategory, mscorlib::System::String* presetName);
		void PlayAnimation(Assembly_CSharp::Doozy::Engine::UI::UIButton* button, bool withSound, UnityEngine_CoreModule::UnityEngine::Events::UnityAction* onStartCallback, UnityEngine_CoreModule::UnityEngine::Events::UnityAction* onCompleteCallback);
		void Reset(Assembly_CSharp::Doozy::Engine::UI::UIButtonBehaviorType behaviorType);
		...
		static float GetDefaultDisableInterval(Assembly_CSharp::Doozy::Engine::UI::UIButtonBehaviorType type);
	};
}
