...
{
	template <typename T1> struct HubConnection___c__DisplayClass72_0_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::SignalRCore::HubConnection::GetIl2CppClass(), "<>c__DisplayClass72_0`1")));
		...
		mscorlib::System::Action_1<T1>* callback;
		void _ctor()
		{
