...
{
	struct AttributePkcs : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Asn1Encodable
	{
		...
		static Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Pkcs::AttributePkcs* GetInstance(mscorlib::System::Object* obj);
