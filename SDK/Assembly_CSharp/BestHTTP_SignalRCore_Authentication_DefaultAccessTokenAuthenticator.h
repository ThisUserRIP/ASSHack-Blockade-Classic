...
namespace Assembly_CSharp::BestHTTP::SignalRCore::Authentication
{
	struct DefaultAccessTokenAuthenticator : mscorlib::System::Object
	{
		...
		Assembly_CSharp::BestHTTP::SignalRCore::HubConnection* _connection;
		...
		void _ctor(Assembly_CSharp::BestHTTP::SignalRCore::HubConnection* connection);
