...
{
	template <typename T1, typename T2, typename T3> struct HubConnection___c__DisplayClass74_0_3 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::SignalRCore::HubConnection::GetIl2CppClass(), "<>c__DisplayClass74_0`3")));
		...
		mscorlib::System::Action_3<T1, T2, T3>* callback;
		void _ctor()
		{
