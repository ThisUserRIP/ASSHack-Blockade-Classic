...
{
	struct RC5Parameters : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::KeyParameter
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t rounds;
		void _ctor(IL2CPP::Array<uint8_t>* key, int32_t rounds);
		int32_t get_Rounds();
	};
}
