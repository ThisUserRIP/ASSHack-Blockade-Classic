...
IL2CPP::Il2CppClass* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Assembly-CSharp.dll", "Doozy.Engine.Utils.ColorModels", "HSL");
	return il2cppclass;
}
mscorlib::System::Type* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::_ctor(float H, float S, float L)
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::Copy()
{
...
UnityEngine_CoreModule::UnityEngine::Color Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::Color(float alpha)
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::RGB* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::ToRGB()
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::Validate()
{
...
float Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::ValidateColor(float value, float min, float max)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::Factorize()
{
...
int32_t Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::FactorizeColor(float value, float min, float max, float f)
{
...
mscorlib::System::String* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSL::ToString(bool factorize)
{
