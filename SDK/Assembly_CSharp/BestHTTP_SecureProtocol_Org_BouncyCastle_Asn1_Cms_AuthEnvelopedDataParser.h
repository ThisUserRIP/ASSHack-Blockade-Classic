...
{
	struct AuthEnvelopedDataParser : mscorlib::System::Object
	{
		...
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser* GetAuthEncryptedContentInfo();
