...
namespace Assembly_CSharp { template <typename V, typename VResult, typename T, typename TResult> struct vp_Message_2_Sender_2; };
...
{
	template <typename V, typename VResult> struct vp_Message_2 : Assembly_CSharp::vp_Message
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Assembly-CSharp.dll", "", "vp_Message`2")));
		...
		Assembly_CSharp::vp_Message_2_Sender_2<V, VResult, V, VResult>* Send;
