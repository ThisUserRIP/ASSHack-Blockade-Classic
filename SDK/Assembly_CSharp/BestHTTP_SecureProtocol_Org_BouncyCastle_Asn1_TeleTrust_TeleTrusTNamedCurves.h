...
{
	struct TeleTrusTNamedCurves : mscorlib::System::Object
	{
		...
		static Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetOid(int16_t curvesize, bool twisted);
		void _ctor();
	};
}
