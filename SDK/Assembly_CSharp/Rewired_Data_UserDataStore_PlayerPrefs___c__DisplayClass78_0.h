...
{
	struct UserDataStore_PlayerPrefs___c__DisplayClass78_0 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Rewired_Core::Rewired::Joystick* joystick;
		void _ctor();
		bool _LoadJoystickAssignmentsNow_b__0(Assembly_CSharp::Rewired::Data::UserDataStore_PlayerPrefs_JoystickAssignmentHistoryInfo* x);
	};
}
