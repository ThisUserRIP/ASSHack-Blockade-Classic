...
IL2CPP::Il2CppClass* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Assembly-CSharp.dll", "Doozy.Engine.Utils.ColorModels", "HSV");
	return il2cppclass;
}
mscorlib::System::Type* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::_ctor(float H, float S, float V)
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::Copy()
{
...
UnityEngine_CoreModule::UnityEngine::Color Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::Color(float alpha)
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::RGB* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::ToRGB()
{
...
Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::Validate()
{
...
float Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::ValidateColor(float value, float min, float max)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::Factorize()
{
...
int32_t Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::FactorizeColor(float value, float min, float max, float f)
{
...
mscorlib::System::String* Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV::ToString(bool factorize)
{
