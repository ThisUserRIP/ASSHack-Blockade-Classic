...
{
	struct SecT283FieldElement : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::AbstractF2mFieldElement
	{
		...
		bool Equals(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Custom::Sec::SecT283FieldElement* other);
		int32_t GetHashCode();
	};
}
