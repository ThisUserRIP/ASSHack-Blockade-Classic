...
namespace Assembly_CSharp { template <typename V, typename T> struct vp_Message_1_Sender_1; };
...
{
	template <typename V> struct vp_Message_1 : Assembly_CSharp::vp_Message
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Assembly-CSharp.dll", "", "vp_Message`1")));
		...
		Assembly_CSharp::vp_Message_1_Sender_1<V, V>* Send;
