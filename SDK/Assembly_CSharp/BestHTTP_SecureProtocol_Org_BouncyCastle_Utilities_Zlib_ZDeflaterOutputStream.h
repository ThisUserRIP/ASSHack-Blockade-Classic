...
{
	struct ZDeflaterOutputStream : mscorlib::System::IO::Stream
	{
		...
		mscorlib::System::IO::Stream* outp;
		struct StaticFields
		{
			int32_t BUFSIZE;
		};
		static StaticFields* GetStaticFields() { return reinterpret_cast<StaticFields*>(GetIl2CppClass()->static_fields); }
		void _ctor(mscorlib::System::IO::Stream* outp);
		void _ctor(mscorlib::System::IO::Stream* outp, int32_t level);
		void _ctor(mscorlib::System::IO::Stream* outp, int32_t level, bool nowrap);
		bool get_CanRead();
		bool get_CanSeek();
		bool get_CanWrite();
		int64_t get_Length();
