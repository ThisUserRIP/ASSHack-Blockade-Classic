...
IL2CPP::Il2CppClass* Assembly_CSharp::TerrainGenerator::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Assembly-CSharp.dll", "", "TerrainGenerator");
	return il2cppclass;
}
mscorlib::System::Type* Assembly_CSharp::TerrainGenerator::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Assembly_CSharp::TerrainGenerator::_ctor(Assembly_CSharp::Map* map)
{
...
void Assembly_CSharp::TerrainGenerator::Generate(int32_t cx, int32_t cz)
{
...
bool Assembly_CSharp::TerrainGenerator::GenerateChunk(Assembly_CSharp::Vector3i chunkPos)
{
...
void Assembly_CSharp::TerrainGenerator::GeneratePlants(int32_t cx, int32_t cz)
{
...
int32_t Assembly_CSharp::TerrainGenerator::GetTerrainHeight(int32_t x, int32_t z)
{
...
int32_t Assembly_CSharp::TerrainGenerator::GetIslandHeight(int32_t x, int32_t z)
{
...
void Assembly_CSharp::TerrainGenerator::GenerateBlockForBaseTerrain(Assembly_CSharp::Vector3i worldPos)
{
...
void Assembly_CSharp::TerrainGenerator::GenerateBlockForIsland(Assembly_CSharp::Vector3i worldPos, int32_t deep, int32_t height)
{
...
bool Assembly_CSharp::TerrainGenerator::IsInRange(float val, float min, float max)
{
