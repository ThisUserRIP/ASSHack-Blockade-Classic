...
namespace Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::TeleTrust { struct TeleTrusTNamedCurves; };
...
namespace Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::TeleTrust
{
	struct TeleTrusTNamedCurves_BrainpoolP512r1Holder : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::X9::X9ECParametersHolder
	{
