...
{
	struct DOTweenCYInstruction_WaitForPosition : UnityEngine_CoreModule::UnityEngine::CustomYieldInstruction
	{
		...
		void _ctor(DOTween::DG::Tweening::Tween* tween, float position);
	};
}
