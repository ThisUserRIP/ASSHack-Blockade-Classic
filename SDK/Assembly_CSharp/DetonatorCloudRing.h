...
{
	struct DetonatorCloudRing : Assembly_CSharp::DetonatorComponent
	{
		...
		UnityEngine_CoreModule::UnityEngine::GameObject* _cloudRing;
		Assembly_CSharp::DetonatorBurstEmitter* _cloudRingEmitter;
		UnityEngine_CoreModule::UnityEngine::Material* cloudRingMaterial;
		void Init();
		void FillMaterials(bool wipe);
		void BuildCloudRing();
		void UpdateCloudRing();
		void Reset();
		void Explode();
		void _ctor();
	};
