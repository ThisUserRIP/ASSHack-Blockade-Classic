...
{
	template <typename TResult> struct HubConnection___c__DisplayClass65_0_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::SignalRCore::HubConnection::GetIl2CppClass(), "<>c__DisplayClass65_0`1")));
		...
		Assembly_CSharp::BestHTTP::Futures::Future_1<TResult>* future;
		...
		void _Invoke_b__0(Assembly_CSharp::BestHTTP::SignalRCore::Messages::Message message)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "<Invoke>b__0", std::vector<std::string> { "BestHTTP.SignalRCore.Messages.Message" });
