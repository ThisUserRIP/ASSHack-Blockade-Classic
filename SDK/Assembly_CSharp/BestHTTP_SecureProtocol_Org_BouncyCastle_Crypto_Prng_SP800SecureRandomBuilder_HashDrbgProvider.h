...
{
	struct SP800SecureRandomBuilder_HashDrbgProvider : mscorlib::System::Object
	{
		...
		void _ctor(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::IDigest* digest, IL2CPP::Array<uint8_t>* nonce, IL2CPP::Array<uint8_t>* personalizationString, int32_t securityStrength);
