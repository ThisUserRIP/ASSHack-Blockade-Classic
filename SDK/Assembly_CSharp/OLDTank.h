...
{
	struct OLDTank : UnityEngine_CoreModule::UnityEngine::MonoBehaviour
	{
		...
		float dlina;
		float shirina;
		UnityEngine_CoreModule::UnityEngine::Transform* MG;
		...
		UnityEngine_CoreModule::UnityEngine::Transform* turretBone;
