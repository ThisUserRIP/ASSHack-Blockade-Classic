...
{
	struct ElGamalParametersGenerator : mscorlib::System::Object
	{
		...
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* GenerateParameters();
		void _ctor();
	};
}
