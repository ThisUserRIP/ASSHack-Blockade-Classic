...
{
	struct CryptoApiEntropySourceProvider : mscorlib::System::Object
	{
		...
		void _ctor();
		void _ctor(mscorlib::System::Security::Cryptography::RandomNumberGenerator* rng, bool isPredictionResistant);
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::IEntropySource* Get(int32_t bitsRequired);
	};
}
