...
{
	struct SP800SecureRandomBuilder_HMacDrbgProvider : mscorlib::System::Object
	{
		...
		void _ctor(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Crypto::IMac* hMac, IL2CPP::Array<uint8_t>* nonce, IL2CPP::Array<uint8_t>* personalizationString, int32_t securityStrength);
