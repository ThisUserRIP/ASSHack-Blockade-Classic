...
{
	template <typename T1, typename T2> struct ThreadedRunner___c__DisplayClass1_0_2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::BestHTTP::PlatformSupport::Threading::ThreadedRunner::GetIl2CppClass(), "<>c__DisplayClass1_0`2")));
		...
		mscorlib::System::Action_2<T1, T2>* job;
		T1 param1;
		T2 param2;
		void _ctor()
		{
