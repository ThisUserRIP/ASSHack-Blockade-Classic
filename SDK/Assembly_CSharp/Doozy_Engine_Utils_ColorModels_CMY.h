...
{
	struct CMY : mscorlib::System::Object
	{
		...
		float m;
		float y;
		void _ctor(float C, float M, float Y);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::CMY* Copy();
		UnityEngine_CoreModule::UnityEngine::Color Color(float alpha);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::RGB* ToRGB();
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::CMY* Validate();
