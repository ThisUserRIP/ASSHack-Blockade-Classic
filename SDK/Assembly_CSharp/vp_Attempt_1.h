...
namespace Assembly_CSharp { template <typename V, typename T> struct vp_Attempt_1_Tryer_1; };
...
{
	template <typename V> struct vp_Attempt_1 : Assembly_CSharp::vp_Attempt
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Assembly-CSharp.dll", "", "vp_Attempt`1")));
		...
		Assembly_CSharp::vp_Attempt_1_Tryer_1<V, V>* Try;
		template <typename T> static bool AlwaysOK(T* value)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "AlwaysOK", std::vector<std::string> { GetGenericTypeName<T>() });
