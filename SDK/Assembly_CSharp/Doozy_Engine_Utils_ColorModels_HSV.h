...
{
	struct HSV : mscorlib::System::Object
	{
		...
		float s;
		float v;
		void _ctor(float H, float S, float V);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV* Copy();
		UnityEngine_CoreModule::UnityEngine::Color Color(float alpha);
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::RGB* ToRGB();
		Assembly_CSharp::Doozy::Engine::Utils::ColorModels::HSV* Validate();
