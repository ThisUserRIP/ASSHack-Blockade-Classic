...
{
	template <typename V, typename T> struct vp_Message_1_Sender_1 : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::vp_Message_1<V>::GetIl2CppClass(), "Sender`1")));
