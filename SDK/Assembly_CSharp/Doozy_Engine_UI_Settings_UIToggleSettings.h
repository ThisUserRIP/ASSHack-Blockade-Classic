...
{
	struct UIToggleSettings : UnityEngine_CoreModule::UnityEngine::ScriptableObject
	{
		...
		struct StaticFields
		{
			...
			Assembly_CSharp::Doozy::Engine::UI::Settings::UIToggleSettings* s_instance;
			bool ALLOW_MULTIPLE_CLICKS_DEFAULT_VALUE;
			bool DESELECT_BUTTON_AFTER_CLICK_DEFAULT_VALUE;
			float BETWEEN_CLICKS_DISABLE_INTERVAL_DEFAULT_VALUE;
			float DEFAULT_BUTTON_HEIGHT;
			float DEFAULT_BUTTON_WIDTH;
		};
		static StaticFields* GetStaticFields() { return reinterpret_cast<StaticFields*>(GetIl2CppClass()->static_fields); }
		static mscorlib::System::String* get_ResourcesPath();
		static Assembly_CSharp::Doozy::Engine::UI::Settings::UIToggleSettings* get_Instance();
		void Reset();
		void Reset(bool saveAssets);
		void ResetComponent(Assembly_CSharp::Doozy::Engine::UI::UIToggle* toggle);
