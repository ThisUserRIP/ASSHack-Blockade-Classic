...
{
	struct ThemeData___c__DisplayClass40_0 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		mscorlib::System::Guid propertyId;
		void _ctor();
		bool _ContainsTextureProperty_b__0(Assembly_CSharp::Doozy::Engine::Themes::LabelId textureLabel);
	};
}
