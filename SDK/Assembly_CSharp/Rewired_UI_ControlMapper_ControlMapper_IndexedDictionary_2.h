...
namespace Assembly_CSharp::Rewired::UI::ControlMapper { template <typename TKey, typename TValue> struct ControlMapper_IndexedDictionary_2_Entry; };
...
{
	template <typename TKey, typename TValue> struct ControlMapper_IndexedDictionary_2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Assembly_CSharp::Rewired::UI::ControlMapper::ControlMapper::GetIl2CppClass(), "IndexedDictionary`2")));
		...
		mscorlib::System::Collections::Generic::List_1<Assembly_CSharp::Rewired::UI::ControlMapper::ControlMapper_IndexedDictionary_2_Entry<TKey, TValue>>* list;
		int32_t get_Count()
		{
		...
		TValue* Get(TKey* key)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Get", std::vector<std::string> { GetGenericTypeName<TKey>() });
			intptr_t* params = new intptr_t[1];
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "TryGet", std::vector<std::string> { GetGenericTypeName<TKey>(), GetGenericTypeName<TValue>() + (std::string)"&" });
