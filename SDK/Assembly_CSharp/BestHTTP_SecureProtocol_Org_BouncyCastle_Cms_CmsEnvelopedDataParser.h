...
namespace Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Cms { struct EnvelopedDataParser; };
...
{
	struct CmsEnvelopedDataParser : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Cms::CmsContentInfoParser
	{
		...
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser* envelopedData;
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* _encAlg;
		Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Cms::AttributeTable* _unprotectedAttributes;
		bool _attrNotRead;
