...
{
	struct Cast5CbcParameters : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Asn1Encodable
	{
		...
		static Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Asn1::Misc::Cast5CbcParameters* GetInstance(mscorlib::System::Object* o);
		void _ctor(IL2CPP::Array<uint8_t>* iv, int32_t keyLength);
