...
{
	struct GraphyDebugger___c__DisplayClass18_0 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t packetId;
		void _ctor();
		bool _GetFirstDebugPacketWithId_b__0(Assembly_CSharp::Tayx::Graphy::GraphyDebugger_DebugPacket* x);
	};
}
