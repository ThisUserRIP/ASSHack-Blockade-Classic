...
{
	struct FluidBlock : Assembly_CSharp::Block
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t face;
		IL2CPP::Array<UnityEngine_CoreModule::UnityEngine::Vector2>* texCoords;
		...
		IL2CPP::Array<UnityEngine_CoreModule::UnityEngine::Vector2>* GetFaceUV();
