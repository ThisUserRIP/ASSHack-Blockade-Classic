...
{
	struct LocalizeTarget_UnityStandard_Prefab : Assembly_CSharp::I2::Loc::LocalizeTarget_1<UnityEngine_CoreModule::UnityEngine::GameObject>
	{
		...
		UnityEngine_CoreModule::UnityEngine::Transform* InstantiateNewPrefab(Assembly_CSharp::I2::Loc::Localize* cmp, mscorlib::System::String* mainTranslation);
		void _ctor();
	};
}
