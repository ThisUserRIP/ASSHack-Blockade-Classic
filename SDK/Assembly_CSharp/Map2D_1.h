...
namespace Assembly_CSharp { template <typename I> struct Chunk2D_1; };
...
{
	template <typename I> struct Map2D_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Assembly-CSharp.dll", "", "Map2D`1")));
		...
		Assembly_CSharp::List2D_1<Assembly_CSharp::Chunk2D_1<I>>* chunks;
		I defaultValue;
		void _ctor()
		{
		...
		Assembly_CSharp::Chunk2D_1<I>* GetChunkInstance(int32_t x, int32_t z)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetChunkInstance", std::vector<std::string> { "System.Int32", "System.Int32" });
			intptr_t* params = new intptr_t[2];
			params[0] = (intptr_t)&x;
			params[1] = (intptr_t)&z;
			Il2CppException* Il2CppException = nullptr;
			...
			delete [] params;
			Il2CppExceptionMessage(Il2CppException);
			return (Assembly_CSharp::Chunk2D_1<I>*)returnValue;
		}
		Assembly_CSharp::Chunk2D_1<I>* GetChunk(int32_t x, int32_t z)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetChunk", std::vector<std::string> { "System.Int32", "System.Int32" });
			intptr_t* params = new intptr_t[2];
			params[0] = (intptr_t)&x;
			params[1] = (intptr_t)&z;
			Il2CppException* Il2CppException = nullptr;
