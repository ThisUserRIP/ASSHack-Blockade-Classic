...
{
	struct ThemeSettings_SelectableSettings : Assembly_CSharp::Rewired::UI::ControlMapper::ThemeSettings_SelectableSettings_Base
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Assembly_CSharp::Rewired::UI::ControlMapper::ThemeSettings_ImageSettings* _imageSettings;
		Assembly_CSharp::Rewired::UI::ControlMapper::ThemeSettings_ImageSettings* get_imageSettings();
