...
IL2CPP::Il2CppClass* Assembly_CSharp::Rewired::Utils::ExternalTools::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Assembly-CSharp.dll", "Rewired.Utils", "ExternalTools");
	return il2cppclass;
}
mscorlib::System::Type* Assembly_CSharp::Rewired::Utils::ExternalTools::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
mscorlib::System::Func_1<mscorlib::System::Object>* Assembly_CSharp::Rewired::Utils::ExternalTools::get_getPlatformInitializerDelegate()
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "get_getPlatformInitializerDelegate");
	Il2CppException* Il2CppException = nullptr;
	IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, nullptr, nullptr, &Il2CppException);
	Il2CppExceptionMessage(Il2CppException);
	return (mscorlib::System::Func_1<mscorlib::System::Object>*)returnValue;
}
void Assembly_CSharp::Rewired::Utils::ExternalTools::set_getPlatformInitializerDelegate(mscorlib::System::Func_1<mscorlib::System::Object>* value)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "set_getPlatformInitializerDelegate", std::vector<std::string> { "System.Func`1<System.Object>" });
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::_ctor()
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::Destroy()
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::get_isEditorPaused()
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::add_EditorPausedStateChangedEvent(mscorlib::System::Action_1<mscorlib::System::Boolean>* value)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::remove_EditorPausedStateChangedEvent(mscorlib::System::Action_1<mscorlib::System::Boolean>* value)
{
...
mscorlib::System::Object* Assembly_CSharp::Rewired::Utils::ExternalTools::GetPlatformInitializer()
{
...
mscorlib::System::String* Assembly_CSharp::Rewired::Utils::ExternalTools::GetFocusedEditorWindowTitle()
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::IsEditorSceneViewFocused()
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::LinuxInput_IsJoystickPreconfigured(mscorlib::System::String* name)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::add_XboxOneInput_OnGamepadStateChange(mscorlib::System::Action_2<mscorlib::System::UInt32, mscorlib::System::Boolean>* value)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::remove_XboxOneInput_OnGamepadStateChange(mscorlib::System::Action_2<mscorlib::System::UInt32, mscorlib::System::Boolean>* value)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOneInput_GetUserIdForGamepad(uint32_t id)
{
...
uint64_t Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOneInput_GetControllerId(uint32_t unityJoystickId)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOneInput_IsGamepadActive(uint32_t unityJoystickId)
{
...
mscorlib::System::String* Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOneInput_GetControllerType(uint64_t xboxControllerId)
{
...
uint32_t Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOneInput_GetJoystickId(uint64_t xboxControllerId)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOne_Gamepad_UpdatePlugin()
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOne_Gamepad_SetGamepadVibration(uint64_t xboxOneJoystickId, float leftMotor, float rightMotor, float leftTriggerLevel, float rightTriggerLevel)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::XboxOne_Gamepad_PulseVibrateMotor(uint64_t xboxOneJoystickId, int32_t motorInt, float startLevel, float endLevel, uint64_t durationMS)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastAcceleration(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastGyro(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector4 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastOrientation(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastTouchData(int32_t id, int32_t& touchNum, int32_t& touch0x, int32_t& touch0y, int32_t& touch0id, int32_t& touch1x, int32_t& touch1y, int32_t& touch1id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetPadControllerInformation(int32_t id, float& touchpixelDensity, int32_t& touchResolutionX, int32_t& touchResolutionY, int32_t& analogDeadZoneLeft, int32_t& analogDeadZoneright, int32_t& connectionType)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadSetMotionSensorState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadSetTiltCorrectionState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadSetAngularVelocityDeadbandState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadSetLightBar(int32_t id, int32_t red, int32_t green, int32_t blue)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadResetLightBar(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadSetVibration(int32_t id, int32_t largeMotor, int32_t smallMotor)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadResetOrientation(int32_t id)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadIsConnected(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetUsersDetails(int32_t slot, mscorlib::System::Object* loggedInUser)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetDeviceClassForHandle(int32_t handle)
{
...
mscorlib::System::String* Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetDeviceClassString(int32_t intValue)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_PadGetUsersHandles2(int32_t maxControllers, IL2CPP::Array<int32_t>* handles)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetSpecialControllerInformation(int32_t id, int32_t padIndex, mscorlib::System::Object* controllerInformation)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialGetLastAcceleration(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialGetLastGyro(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector4 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialGetLastOrientation(int32_t id)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialGetUsersHandles(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* handles)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialGetUsersHandles2(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* handles)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialIsConnected(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialResetLightSphere(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialResetOrientation(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialSetAngularVelocityDeadbandState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialSetLightSphere(int32_t id, int32_t red, int32_t green, int32_t blue)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialSetMotionSensorState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialSetTiltCorrectionState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_SpecialSetVibration(int32_t id, int32_t largeMotor, int32_t smallMotor)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimGetLastAcceleration(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimGetLastGyro(int32_t id)
{
...
UnityEngine_CoreModule::UnityEngine::Vector4 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimGetLastOrientation(int32_t id)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimGetUsersHandles(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* handles)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimGetUsersHandles2(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* handles)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimIsConnected(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimResetLightSphere(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimResetOrientation(int32_t id)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimSetAngularVelocityDeadbandState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimSetLightSphere(int32_t id, int32_t red, int32_t green, int32_t blue)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimSetMotionSensorState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimSetTiltCorrectionState(int32_t id, bool bEnable)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_AimSetVibration(int32_t id, int32_t largeMotor, int32_t smallMotor)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastMoveAcceleration(int32_t id, int32_t index)
{
...
UnityEngine_CoreModule::UnityEngine::Vector3 Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_GetLastMoveGyro(int32_t id, int32_t index)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetButtons(int32_t id, int32_t index)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetAnalogButton(int32_t id, int32_t index)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveIsConnected(int32_t id, int32_t index)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetUsersMoveHandles(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* primaryHandles, IL2CPP::Array<int32_t>* secondaryHandles)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetUsersMoveHandles(int32_t maxNumberControllers, IL2CPP::Array<int32_t>* primaryHandles)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetUsersMoveHandles(int32_t maxNumberControllers)
{
...
intptr_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveGetControllerInputForTracking()
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveSetLightSphere(int32_t id, int32_t index, int32_t red, int32_t green, int32_t blue)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::PS4Input_MoveSetVibration(int32_t id, int32_t index, int32_t motor)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::GetDeviceVIDPIDs(mscorlib::System::Collections::Generic::List_1<mscorlib::System::Int32>& vids, mscorlib::System::Collections::Generic::List_1<mscorlib::System::Int32>& pids)
{
...
int32_t Assembly_CSharp::Rewired::Utils::ExternalTools::GetAndroidAPILevel()
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::UnityUI_Graphic_GetRaycastTarget(mscorlib::System::Object* graphic)
{
...
void Assembly_CSharp::Rewired::Utils::ExternalTools::UnityUI_Graphic_SetRaycastTarget(mscorlib::System::Object* graphic, bool value)
{
...
bool Assembly_CSharp::Rewired::Utils::ExternalTools::get_UnityInput_IsTouchPressureSupported()
{
...
float Assembly_CSharp::Rewired::Utils::ExternalTools::UnityInput_GetTouchPressure(UnityEngine_InputLegacyModule::UnityEngine::Touch& touch)
{
...
float Assembly_CSharp::Rewired::Utils::ExternalTools::UnityInput_GetTouchMaximumPossiblePressure(UnityEngine_InputLegacyModule::UnityEngine::Touch& touch)
{
...
Rewired_Core::Rewired::IControllerTemplate* Assembly_CSharp::Rewired::Utils::ExternalTools::CreateControllerTemplate(mscorlib::System::Guid typeGuid, mscorlib::System::Object* payload)
{
...
IL2CPP::Array<mscorlib::System::Type*>* Assembly_CSharp::Rewired::Utils::ExternalTools::GetControllerTemplateTypes()
{
...
IL2CPP::Array<mscorlib::System::Type*>* Assembly_CSharp::Rewired::Utils::ExternalTools::GetControllerTemplateInterfaceTypes()
{
