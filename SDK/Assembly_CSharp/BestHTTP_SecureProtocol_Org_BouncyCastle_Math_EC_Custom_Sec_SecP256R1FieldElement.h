...
{
	struct SecP256R1FieldElement : Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::AbstractFpFieldElement
	{
		...
		bool Equals(Assembly_CSharp::BestHTTP::SecureProtocol::Org::BouncyCastle::Math::EC::Custom::Sec::SecP256R1FieldElement* other);
		int32_t GetHashCode();
		static void _cctor();
	};
}
