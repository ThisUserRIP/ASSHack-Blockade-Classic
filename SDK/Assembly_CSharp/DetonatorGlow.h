...
{
	struct DetonatorGlow : Assembly_CSharp::DetonatorComponent
	{
		...
		UnityEngine_CoreModule::UnityEngine::GameObject* _glow;
		Assembly_CSharp::DetonatorBurstEmitter* _glowEmitter;
