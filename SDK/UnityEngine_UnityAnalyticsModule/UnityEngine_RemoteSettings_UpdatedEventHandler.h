...
namespace UnityEngine_UnityAnalyticsModule::UnityEngine { struct RemoteSettings; };
...
{
	struct RemoteSettings_UpdatedEventHandler : mscorlib::System::MulticastDelegate
	{
