...
namespace Unity_TextMeshPro::TMPro { struct TMP_Dropdown_OptionDataList; };
namespace Unity_TextMeshPro::TMPro { struct TMP_Dropdown_DropdownEvent; };
#include "..\mscorlib\System_Single.h"
namespace mscorlib::System { struct Single; };
namespace UnityEngine_CoreModule::UnityEngine { struct GameObject; };
namespace Unity_TextMeshPro::TMPro { struct TMP_Dropdown_DropdownItem; };
namespace mscorlib::System::Collections::Generic { template <typename T> struct List_1; };
#include "TMPro_FloatTween.h"
namespace Unity_TextMeshPro::TMPro { struct FloatTween; };
namespace Unity_TextMeshPro::TMPro { template <typename T> struct TweenRunner_1; };
...
{
	struct TMP_Dropdown : UnityEngine_UI::UnityEngine::UI::Selectable
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		UnityEngine_CoreModule::UnityEngine::RectTransform* m_Template;
		Unity_TextMeshPro::TMPro::TMP_Text* m_CaptionText;
		UnityEngine_UI::UnityEngine::UI::Image* m_CaptionImage;
		UnityEngine_UI::UnityEngine::UI::Graphic* m_Placeholder;
		Unity_TextMeshPro::TMPro::TMP_Text* m_ItemText;
		UnityEngine_UI::UnityEngine::UI::Image* m_ItemImage;
		int32_t m_Value;
		Unity_TextMeshPro::TMPro::TMP_Dropdown_OptionDataList* m_Options;
		Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownEvent* m_OnValueChanged;
		...
		mscorlib::System::Collections::Generic::List_1<Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem>* m_Items;
		Unity_TextMeshPro::TMPro::TweenRunner_1<Unity_TextMeshPro::TMPro::FloatTween>* m_AlphaTweenRunner;
		bool validTemplate;
		UnityEngine_CoreModule::UnityEngine::Coroutine* m_Coroutine;
		struct StaticFields
		{
			Unity_TextMeshPro::TMPro::TMP_Dropdown_OptionData* s_NoOptionData;
		};
		...
		Unity_TextMeshPro::TMPro::TMP_Text* get_captionText();
		void set_captionText(Unity_TextMeshPro::TMPro::TMP_Text* value);
		...
		Unity_TextMeshPro::TMPro::TMP_Text* get_itemText();
		void set_itemText(Unity_TextMeshPro::TMPro::TMP_Text* value);
		...
		Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownEvent* get_onValueChanged();
		void set_onValueChanged(Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownEvent* value);
		...
		void AddOptions(mscorlib::System::Collections::Generic::List_1<Unity_TextMeshPro::TMPro::TMP_Dropdown_OptionData>* options);
		...
		Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem* CreateItem(Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem* itemTemplate);
		void DestroyItem(Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem* item);
		Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem* AddItem(Unity_TextMeshPro::TMPro::TMP_Dropdown_OptionData* data, bool selected, Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem* itemTemplate, mscorlib::System::Collections::Generic::List_1<Unity_TextMeshPro::TMPro::TMP_Dropdown_DropdownItem>* items);
