...
{
	struct TMP_MaterialManager___c__DisplayClass12_0 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		UnityEngine_CoreModule::UnityEngine::Material* stencilMaterial;
		void _ctor();
		bool _RemoveStencilMaterial_b__0(Unity_TextMeshPro::TMPro::TMP_MaterialManager_MaskingMaterial* item);
	};
}
