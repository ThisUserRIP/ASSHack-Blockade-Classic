...
namespace UnityEngine_ParticleSystemModule::UnityEngine
{
	struct ParticleSystem_LightsModule
	{
		...
		static bool get_enabled_Injected(UnityEngine_ParticleSystemModule::UnityEngine::ParticleSystem_LightsModule& _unity_self);
		static void set_enabled_Injected(UnityEngine_ParticleSystemModule::UnityEngine::ParticleSystem_LightsModule& _unity_self, bool value);
	};
}
