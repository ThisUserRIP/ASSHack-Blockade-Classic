...
namespace UnityEngine_CoreModule::Unity::Jobs { struct IJobExtensions; };
...
namespace UnityEngine_CoreModule::Unity::Jobs
{
	template <typename T> struct IJobExtensions_JobStruct_1
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(UnityEngine_CoreModule::Unity::Jobs::IJobExtensions::GetIl2CppClass(), "JobStruct`1")));
		...
		static void Execute(T& data, intptr_t additionalPtr, intptr_t bufferRangePatchData, UnityEngine_CoreModule::Unity::Jobs::LowLevel::Unsafe::JobRanges& ranges, int32_t jobIndex)
		{
