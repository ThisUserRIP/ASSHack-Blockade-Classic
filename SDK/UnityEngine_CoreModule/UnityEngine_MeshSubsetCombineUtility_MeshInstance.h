...
{
	struct MeshSubsetCombineUtility_MeshInstance
	{
		...
		int32_t enlightenVertexStreamMeshInstanceID;
		UnityEngine_CoreModule::UnityEngine::Matrix4x4 transform;
		UnityEngine_CoreModule::UnityEngine::Vector4 lightmapScaleOffset;
		UnityEngine_CoreModule::UnityEngine::Vector4 realtimeLightmapScaleOffset;
	};
}
