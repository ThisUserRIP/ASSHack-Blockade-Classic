...
namespace UnityEngine_CoreModule::UnityEngine::Events { template <typename T0, typename T1, typename T2, typename T3> struct UnityAction_4; };
...
{
	template <typename T1, typename T2, typename T3, typename T4> struct InvokableCall_4 : UnityEngine_CoreModule::UnityEngine::Events::BaseInvokableCall
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("UnityEngine.CoreModule.dll", "UnityEngine.Events", "InvokableCall`4")));
		...
		UnityEngine_CoreModule::UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>* Delegate;
