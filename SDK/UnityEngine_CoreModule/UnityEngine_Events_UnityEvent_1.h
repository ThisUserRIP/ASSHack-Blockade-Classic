...
{
	template <typename T0> struct UnityEvent_1 : UnityEngine_CoreModule::UnityEngine::Events::UnityEventBase
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("UnityEngine.CoreModule.dll", "UnityEngine.Events", "UnityEvent`1")));
		...
		void AddListener(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_1<T0>* call)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "AddListener", std::vector<std::string> { "UnityEngine.Events.UnityAction`1<T0>" });
		...
		void RemoveListener(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_1<T0>* call)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "RemoveListener", std::vector<std::string> { "UnityEngine.Events.UnityAction`1<T0>" });
			intptr_t* params = new intptr_t[1];
			params[0] = (intptr_t)call;
			Il2CppException* Il2CppException = nullptr;
			il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
		...
		static UnityEngine_CoreModule::UnityEngine::Events::BaseInvokableCall* GetDelegate(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_1<T0>* action)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetDelegate", std::vector<std::string> { "UnityEngine.Events.UnityAction`1<T0>" });
			intptr_t* params = new intptr_t[1];
		...
		void Invoke(T0* arg0)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Invoke", std::vector<std::string> { GetGenericTypeName<T0>() });
			intptr_t* params = new intptr_t[1];
