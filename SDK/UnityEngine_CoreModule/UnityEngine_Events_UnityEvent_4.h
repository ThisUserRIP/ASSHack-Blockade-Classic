...
{
	template <typename T0, typename T1, typename T2, typename T3> struct UnityEvent_4 : UnityEngine_CoreModule::UnityEngine::Events::UnityEventBase
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("UnityEngine.CoreModule.dll", "UnityEngine.Events", "UnityEvent`4")));
