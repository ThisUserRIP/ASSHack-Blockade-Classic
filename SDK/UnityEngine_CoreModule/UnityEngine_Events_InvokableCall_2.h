...
{
	template <typename T1, typename T2> struct InvokableCall_2 : UnityEngine_CoreModule::UnityEngine::Events::BaseInvokableCall
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("UnityEngine.CoreModule.dll", "UnityEngine.Events", "InvokableCall`2")));
		...
		UnityEngine_CoreModule::UnityEngine::Events::UnityAction_2<T1, T2>* Delegate;
		void add_Delegate(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_2<T1, T2>* value)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "add_Delegate", std::vector<std::string> { "UnityEngine.Events.UnityAction`2<T1,T2>" });
		...
		void remove_Delegate(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_2<T1, T2>* value)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "remove_Delegate", std::vector<std::string> { "UnityEngine.Events.UnityAction`2<T1,T2>" });
			intptr_t* params = new intptr_t[1];
			params[0] = (intptr_t)value;
			Il2CppException* Il2CppException = nullptr;
			il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
		...
		void _ctor(UnityEngine_CoreModule::UnityEngine::Events::UnityAction_2<T1, T2>* action)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "UnityEngine.Events.UnityAction`2<T1,T2>" });
			intptr_t* params = new intptr_t[1];
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Invoke", std::vector<std::string> { GetGenericTypeName<T1>(), GetGenericTypeName<T2>() });
			intptr_t* params = new intptr_t[2];
			params[0] = (intptr_t)args0;
			params[1] = (intptr_t)args1;
			Il2CppException* Il2CppException = nullptr;
			il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
			delete [] params;
			Il2CppExceptionMessage(Il2CppException);
