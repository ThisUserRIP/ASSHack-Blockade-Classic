...
namespace UnityEngine_CoreModule::Unity::Collections
{
	template <typename T> struct NativeSlice_1_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(UnityEngine_CoreModule::Unity::Collections::NativeSlice_1<T>::GetIl2CppClass(), "Enumerator")));
		...
		UnityEngine_CoreModule::Unity::Collections::NativeSlice_1<T> m_Array;
		int32_t m_Index;
		void _ctor(UnityEngine_CoreModule::Unity::Collections::NativeSlice_1<T>& array)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "Unity.Collections.NativeSlice`1<T>&" });
