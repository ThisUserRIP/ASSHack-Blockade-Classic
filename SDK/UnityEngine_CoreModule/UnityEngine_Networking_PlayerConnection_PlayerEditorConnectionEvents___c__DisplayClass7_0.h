...
{
	struct PlayerEditorConnectionEvents___c__DisplayClass7_0 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		mscorlib::System::Guid messageId;
		void _ctor();
		bool _AddAndCreate_b__0(UnityEngine_CoreModule::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageTypeSubscribers* x);
	};
}
