...
{
	template <typename TValue> struct PriorityQueue_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("Unity.RenderPipelines.Universal.Runtime.dll", "UnityEngine.Experimental.Rendering.Universal.LibTessDotNet", "PriorityQueue`1")));
		...
		Unity_RenderPipelines_Universal_Runtime::UnityEngine::Experimental::Rendering::Universal::LibTessDotNet::PriorityHeap_1<TValue>* _heap;
		IL2CPP::Array<TValue>* _keys;
		IL2CPP::Array<int32_t>* _order;
		int32_t _size;
		int32_t _max;
		bool _initialized;
		bool get_Empty()
