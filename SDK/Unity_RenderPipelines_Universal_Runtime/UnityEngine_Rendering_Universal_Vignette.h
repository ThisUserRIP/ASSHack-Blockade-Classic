...
{
	struct Vignette : Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::VolumeComponent
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::ColorParameter* color;
		...
		Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::ClampedFloatParameter* smoothness;
		Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::BoolParameter* rounded;
		bool IsActive();
