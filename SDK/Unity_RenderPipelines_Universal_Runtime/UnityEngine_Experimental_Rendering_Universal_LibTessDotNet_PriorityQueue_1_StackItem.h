...
{
	template <typename TValue> struct PriorityQueue_1_StackItem : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(Unity_RenderPipelines_Universal_Runtime::UnityEngine::Experimental::Rendering::Universal::LibTessDotNet::PriorityQueue_1<TValue>::GetIl2CppClass(), "StackItem")));
