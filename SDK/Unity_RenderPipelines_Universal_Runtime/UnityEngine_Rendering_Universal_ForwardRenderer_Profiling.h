...
{
	struct ForwardRenderer_Profiling : mscorlib::System::Object
	{
		...
		struct StaticFields
		{
			...
			Unity_RenderPipelines_Core_Runtime::UnityEngine::Rendering::ProfilingSampler* createCameraRenderTarget;
		};
