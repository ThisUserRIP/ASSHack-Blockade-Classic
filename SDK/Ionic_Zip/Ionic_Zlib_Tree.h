...
namespace Ionic_Zip::Ionic::Zlib { struct StaticTree; };
...
{
	struct Tree : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		IL2CPP::Array<int16_t>* dyn_tree;
		int32_t max_code;
		Ionic_Zip::Ionic::Zlib::StaticTree* staticTree;
		struct StaticFields
		{
			int32_t HEAP_SIZE;
		...
		void gen_bitlen(Ionic_Zip::Ionic::Zlib::DeflateManager* s);
		void build_tree(Ionic_Zip::Ionic::Zlib::DeflateManager* s);
