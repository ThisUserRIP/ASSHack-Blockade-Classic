...
IL2CPP::Il2CppClass* Ionic_Zip::Ionic::Zlib::ZlibCodec::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("Ionic.Zip.dll", "Ionic.Zlib", "ZlibCodec");
	return il2cppclass;
}
mscorlib::System::Type* Ionic_Zip::Ionic::Zlib::ZlibCodec::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void Ionic_Zip::Ionic::Zlib::ZlibCodec::_ctor()
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::InitializeInflate(bool expectRfc1950Header)
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::InitializeInflate(int32_t windowBits, bool expectRfc1950Header)
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::Inflate(Ionic_Zip::Ionic::Zlib::FlushType flush)
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::EndInflate()
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::InitializeDeflate(Ionic_Zip::Ionic::Zlib::CompressionLevel level, bool wantRfc1950Header)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "InitializeDeflate", std::vector<std::string> { "Ionic.Zlib.CompressionLevel", "System.Boolean" });
	intptr_t* params = new intptr_t[2];
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::_InternalInitializeDeflate(bool wantRfc1950Header)
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::Deflate(Ionic_Zip::Ionic::Zlib::FlushType flush)
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::EndDeflate()
{
...
void Ionic_Zip::Ionic::Zlib::ZlibCodec::flush_pending()
{
...
int32_t Ionic_Zip::Ionic::Zlib::ZlibCodec::read_buf(IL2CPP::Array<uint8_t>* buf, int32_t start, int32_t size)
{
