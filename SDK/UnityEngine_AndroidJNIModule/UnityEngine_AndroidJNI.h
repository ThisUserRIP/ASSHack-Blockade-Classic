...
{
	struct AndroidJNI : mscorlib::System::Object
	{
		...
		static intptr_t ExceptionOccurred();
		static void ExceptionClear();
		static int32_t PushLocalFrame(int32_t capacity);
		static intptr_t PopLocalFrame(intptr_t ptr);
		static intptr_t NewGlobalRef(intptr_t obj);
		static void DeleteGlobalRef(intptr_t obj);
		static intptr_t NewWeakGlobalRef(intptr_t obj);
		static void DeleteWeakGlobalRef(intptr_t obj);
		static intptr_t NewLocalRef(intptr_t obj);
		static void DeleteLocalRef(intptr_t obj);
		...
		static intptr_t GetObjectClass(intptr_t obj);
		static intptr_t GetMethodID(intptr_t clazz, mscorlib::System::String* name, mscorlib::System::String* sig);
		...
		static intptr_t NewStringFromStr(mscorlib::System::String* chars);
		...
		static intptr_t ToObjectArray(IL2CPP::Array<intptr_t>* array, intptr_t arrayClass);
		...
		static intptr_t NewObjectArray(int32_t size, intptr_t clazz, intptr_t obj);
		static intptr_t GetObjectArrayElement(intptr_t array, int32_t index);
		static void SetObjectArrayElement(intptr_t array, int32_t index, intptr_t obj);
	};
}
