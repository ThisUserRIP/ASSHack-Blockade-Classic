...
namespace Rewired_Windows::Rewired::Libraries::SharpDX::DirectInput { struct DirectInput_GetDeviceCountHelper; };
...
{
	struct DirectInput_GetDeviceCountHelper_DirectInputEnumDevicesDelegate : mscorlib::System::MulticastDelegate
	{
