...
{
	template <typename EnumType> struct EnumByteTypeInfo_1 : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<EnumType>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System.Diagnostics.Tracing", "EnumByteTypeInfo`1")));
