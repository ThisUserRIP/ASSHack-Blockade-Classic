...
{
	struct UIntPtrArrayTypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<IL2CPP::Array<mscorlib::System::UIntPtr>>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, IL2CPP::Array<uintptr_t>& value);
		void _ctor();
	};
}
