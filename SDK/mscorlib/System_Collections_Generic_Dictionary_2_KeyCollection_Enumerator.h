...
namespace mscorlib::System::Collections::Generic
{
	template <typename TKey, typename TValue> struct Dictionary_2_KeyCollection_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::Collections::Generic::Dictionary_2_KeyCollection<TKey, TValue>::GetIl2CppClass(), "Enumerator")));
