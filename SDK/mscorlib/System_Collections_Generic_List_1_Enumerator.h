...
namespace mscorlib::System::Collections::Generic
{
	template <typename T> struct List_1_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::Collections::Generic::List_1<T>::GetIl2CppClass(), "Enumerator")));
		...
		mscorlib::System::Collections::Generic::List_1<T>* list;
		int32_t index;
		int32_t version;
		T current;
		void _ctor(mscorlib::System::Collections::Generic::List_1<T>* list)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.List`1<T>" });
		...
		bool MoveNextRare()
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "MoveNextRare");
			Il2CppException* Il2CppException = nullptr;
			IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, this, nullptr, &Il2CppException);
			Il2CppExceptionMessage(Il2CppException);
			if (returnValue == nullptr)
