...
namespace mscorlib::System
{
	struct Int16
	{
		...
		mscorlib::System::String* ToString(mscorlib::System::String* format, mscorlib::System::Globalization::NumberFormatInfo* info);
		static int16_t Parse(mscorlib::System::String* s);
		static int16_t Parse(mscorlib::System::String* s, mscorlib::System::IFormatProvider* provider);
		static int16_t Parse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::IFormatProvider* provider);
		static int16_t Parse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::Globalization::NumberFormatInfo* info);
		static bool TryParse(mscorlib::System::String* s, int16_t& result);
		static bool TryParse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::IFormatProvider* provider, int16_t& result);
		static bool TryParse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::Globalization::NumberFormatInfo* info, int16_t& result);
