...
{
	struct ByteArrayTypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<IL2CPP::Array<mscorlib::System::Byte>>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, IL2CPP::Array<uint8_t>& value);
		void _ctor();
	};
}
