...
{
	struct ByteTypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<mscorlib::System::Byte>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, uint8_t& value);
		void _ctor();
	};
}
