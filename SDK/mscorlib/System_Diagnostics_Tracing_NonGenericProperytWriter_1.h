...
{
	template <typename ContainerType> struct NonGenericProperytWriter_1 : mscorlib::System::Diagnostics::Tracing::PropertyAccessor_1<ContainerType>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System.Diagnostics.Tracing", "NonGenericProperytWriter`1")));
