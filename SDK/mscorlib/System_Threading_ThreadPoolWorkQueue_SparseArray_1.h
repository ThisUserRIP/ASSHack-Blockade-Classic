...
{
	template <typename T> struct ThreadPoolWorkQueue_SparseArray_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::Threading::ThreadPoolWorkQueue::GetIl2CppClass(), "SparseArray`1")));
