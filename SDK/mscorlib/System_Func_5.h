...
{
	template <typename T1, typename T2, typename T3, typename T4, typename TResult> struct Func_5 : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			IL2CPP::Array<mscorlib::System::Type*>* arrayType = new IL2CPP::Array<mscorlib::System::Type*>();
			arrayType->max_length = 5;
			...
			arrayType->vector[4] = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(TResult::GetIl2CppClass()));
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System", "Func`5")));
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Invoke", std::vector<std::string> { GetGenericTypeName<T1>(), GetGenericTypeName<T2>(), GetGenericTypeName<T3>(), GetGenericTypeName<T4>() });
			const IL2CPP::MethodInfo* virtualAddress = il2cpp_object_get_virtual_method(this, address);
			intptr_t* params = new intptr_t[4];
			params[0] = (intptr_t)arg1;
			params[1] = (intptr_t)arg2;
			params[2] = (intptr_t)arg3;
			params[3] = (intptr_t)arg4;
			Il2CppException* Il2CppException = nullptr;
		...
		mscorlib::System::IAsyncResult* BeginInvoke(T1* arg1, T2* arg2, T3* arg3, T4* arg4, mscorlib::System::AsyncCallback* callback, mscorlib::System::Object* object)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "BeginInvoke", std::vector<std::string> { GetGenericTypeName<T1>(), GetGenericTypeName<T2>(), GetGenericTypeName<T3>(), GetGenericTypeName<T4>(), "System.AsyncCallback", "System.Object" });
			const IL2CPP::MethodInfo* virtualAddress = il2cpp_object_get_virtual_method(this, address);
