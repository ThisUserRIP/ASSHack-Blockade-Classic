...
{
	template <typename T> struct ArraySegment_1_ArraySegmentEnumerator : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::ArraySegment_1<T>::GetIl2CppClass(), "ArraySegmentEnumerator")));
		...
		int32_t _end;
		int32_t _current;
		void _ctor(mscorlib::System::ArraySegment_1<T> arraySegment)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.ArraySegment`1<T>" });
			intptr_t* params = new intptr_t[1];
			params[0] = (intptr_t)&arraySegment;
