...
{
	template <typename T> struct ShortEnumEqualityComparer_1 : mscorlib::System::Collections::Generic::EnumEqualityComparer_1<T>
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System.Collections.Generic", "ShortEnumEqualityComparer`1")));
