...
{
	template <typename TKey, typename TValue> struct ConditionalWeakTable_2_CreateValueCallback : mscorlib::System::MulticastDelegate
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::Runtime::CompilerServices::ConditionalWeakTable_2<TKey, TValue>::GetIl2CppClass(), "CreateValueCallback")));
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Invoke", std::vector<std::string> { GetGenericTypeName<TKey>() });
		...
		mscorlib::System::IAsyncResult* BeginInvoke(TKey* key, mscorlib::System::AsyncCallback* callback, mscorlib::System::Object* object)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "BeginInvoke", std::vector<std::string> { GetGenericTypeName<TKey>(), "System.AsyncCallback", "System.Object" });
			const IL2CPP::MethodInfo* virtualAddress = il2cpp_object_get_virtual_method(this, address);
		...
		TValue* EndInvoke(mscorlib::System::IAsyncResult* result)
		{
