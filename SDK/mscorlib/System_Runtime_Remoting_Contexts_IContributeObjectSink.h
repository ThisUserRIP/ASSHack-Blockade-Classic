...
namespace mscorlib::System::Runtime::Remoting::Contexts
{
	struct IContributeObjectSink
	{
		...
		mscorlib::System::Runtime::Remoting::Messaging::IMessageSink* GetObjectSink(mscorlib::System::MarshalByRefObject* obj, mscorlib::System::Runtime::Remoting::Messaging::IMessageSink* nextSink);
	};
}
