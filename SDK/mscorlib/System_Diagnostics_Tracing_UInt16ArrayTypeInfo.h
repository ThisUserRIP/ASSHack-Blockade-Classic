...
{
	struct UInt16ArrayTypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<IL2CPP::Array<mscorlib::System::UInt16>>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, IL2CPP::Array<uint16_t>& value);
		void _ctor();
	};
}
