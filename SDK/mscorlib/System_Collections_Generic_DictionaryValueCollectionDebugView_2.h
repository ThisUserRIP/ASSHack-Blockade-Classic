...
{
	template <typename TKey, typename TValue> struct DictionaryValueCollectionDebugView_2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System.Collections.Generic", "DictionaryValueCollectionDebugView`2")));
