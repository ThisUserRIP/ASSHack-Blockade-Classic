...
{
	template <typename T> struct ReadOnlyCollection_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System.Collections.ObjectModel", "ReadOnlyCollection`1")));
		...
		mscorlib::System::Collections::Generic::IList_1<T>* list;
