...
IL2CPP::Il2CppClass* mscorlib::System::Text::UTF32Encoding::GetIl2CppClass()
{
	static IL2CPP::Il2CppClass* il2cppclass = GetIL2CppClass("mscorlib.dll", "System.Text", "UTF32Encoding");
	return il2cppclass;
}
mscorlib::System::Type* mscorlib::System::Text::UTF32Encoding::GetIl2CppType()
{
	static mscorlib::System::Type* il2cpptype = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(GetIl2CppClass()));
	return il2cpptype;
}
void mscorlib::System::Text::UTF32Encoding::_ctor()
{
...
void mscorlib::System::Text::UTF32Encoding::_ctor(bool bigEndian, bool byteOrderMark)
{
...
void mscorlib::System::Text::UTF32Encoding::_ctor(bool bigEndian, bool byteOrderMark, bool throwOnInvalidCharacters)
{
	...
	params[0] = (intptr_t)&bigEndian;
	params[1] = (intptr_t)&byteOrderMark;
	params[2] = (intptr_t)&throwOnInvalidCharacters;
	Il2CppException* Il2CppException = nullptr;
	il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
	delete [] params;
	Il2CppExceptionMessage(Il2CppException);
}
void mscorlib::System::Text::UTF32Encoding::SetDefaultFallbacks()
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetByteCount(IL2CPP::Array<wchar_t>* chars, int32_t index, int32_t count)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetByteCount(mscorlib::System::String* s)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetByteCount(wchar_t* chars, int32_t count)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetBytes(mscorlib::System::String* s, int32_t charIndex, int32_t charCount, IL2CPP::Array<uint8_t>* bytes, int32_t byteIndex)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetBytes(IL2CPP::Array<wchar_t>* chars, int32_t charIndex, int32_t charCount, IL2CPP::Array<uint8_t>* bytes, int32_t byteIndex)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetBytes(wchar_t* chars, int32_t charCount, uint8_t* bytes, int32_t byteCount)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetCharCount(IL2CPP::Array<uint8_t>* bytes, int32_t index, int32_t count)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetCharCount(uint8_t* bytes, int32_t count)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetChars(IL2CPP::Array<uint8_t>* bytes, int32_t byteIndex, int32_t byteCount, IL2CPP::Array<wchar_t>* chars, int32_t charIndex)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetChars(uint8_t* bytes, int32_t byteCount, wchar_t* chars, int32_t charCount)
{
...
mscorlib::System::String* mscorlib::System::Text::UTF32Encoding::GetString(IL2CPP::Array<uint8_t>* bytes, int32_t index, int32_t count)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetByteCount(wchar_t* chars, int32_t count, mscorlib::System::Text::EncoderNLS* encoder)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetBytes(wchar_t* chars, int32_t charCount, uint8_t* bytes, int32_t byteCount, mscorlib::System::Text::EncoderNLS* encoder)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetCharCount(uint8_t* bytes, int32_t count, mscorlib::System::Text::DecoderNLS* baseDecoder)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetChars(uint8_t* bytes, int32_t byteCount, wchar_t* chars, int32_t charCount, mscorlib::System::Text::DecoderNLS* baseDecoder)
{
...
uint32_t mscorlib::System::Text::UTF32Encoding::GetSurrogate(wchar_t cHigh, wchar_t cLow)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetSurrogate", std::vector<std::string> { "System.Char", "System.Char" });
	intptr_t* params = new intptr_t[2];
	params[0] = (intptr_t)&cHigh;
	params[1] = (intptr_t)&cLow;
	Il2CppException* Il2CppException = nullptr;
...
wchar_t mscorlib::System::Text::UTF32Encoding::GetHighSurrogate(uint32_t iChar)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetHighSurrogate", std::vector<std::string> { "System.UInt32" });
	intptr_t* params = new intptr_t[1];
	params[0] = (intptr_t)&iChar;
	Il2CppException* Il2CppException = nullptr;
	IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
	delete [] params;
	Il2CppExceptionMessage(Il2CppException);
...
wchar_t mscorlib::System::Text::UTF32Encoding::GetLowSurrogate(uint32_t iChar)
{
	static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "GetLowSurrogate", std::vector<std::string> { "System.UInt32" });
	intptr_t* params = new intptr_t[1];
	params[0] = (intptr_t)&iChar;
	Il2CppException* Il2CppException = nullptr;
	IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
...
mscorlib::System::Text::Decoder* mscorlib::System::Text::UTF32Encoding::GetDecoder()
{
...
mscorlib::System::Text::Encoder* mscorlib::System::Text::UTF32Encoding::GetEncoder()
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetMaxByteCount(int32_t charCount)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetMaxCharCount(int32_t byteCount)
{
...
IL2CPP::Array<uint8_t>* mscorlib::System::Text::UTF32Encoding::GetPreamble()
{
...
bool mscorlib::System::Text::UTF32Encoding::Equals(mscorlib::System::Object* value)
{
...
int32_t mscorlib::System::Text::UTF32Encoding::GetHashCode()
{
