...
{
	struct Int16TypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<mscorlib::System::Int16>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, int16_t& value);
		void _ctor();
	};
}
