...
{
	struct RSAOAEPKeyExchangeDeformatter : mscorlib::System::Security::Cryptography::AsymmetricKeyExchangeDeformatter
	{
		...
		IL2CPP::Array<uint8_t>* DecryptKeyExchange(IL2CPP::Array<uint8_t>* rgbData);
