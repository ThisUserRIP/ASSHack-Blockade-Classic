...
namespace mscorlib::System
{
	template <typename T> struct RuntimeType_ListBuilder_1
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::RuntimeType::GetIl2CppClass(), "ListBuilder`1")));
		...
		void CopyTo(IL2CPP::Array<mscorlib::System::Object*>* array, int32_t index)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "CopyTo", std::vector<std::string> { "System.Object[]", "System.Int32" });
