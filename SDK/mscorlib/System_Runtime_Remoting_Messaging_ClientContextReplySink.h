...
{
	struct ClientContextReplySink : mscorlib::System::Object
	{
		...
		void _ctor(mscorlib::System::Runtime::Remoting::Contexts::Context* ctx, mscorlib::System::Runtime::Remoting::Messaging::IMessageSink* replySink);
