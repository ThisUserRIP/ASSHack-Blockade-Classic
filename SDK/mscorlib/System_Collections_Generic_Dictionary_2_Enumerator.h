...
namespace mscorlib::System::Collections::Generic
{
	template <typename TKey, typename TValue> struct Dictionary_2_Enumerator
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(mscorlib::System::Collections::Generic::Dictionary_2<TKey, TValue>::GetIl2CppClass(), "Enumerator")));
		...
		int32_t version;
		int32_t index;
		mscorlib::System::Collections::Generic::KeyValuePair_2<TKey, TValue> current;
		int32_t getEnumeratorRetType;
		void _ctor(mscorlib::System::Collections::Generic::Dictionary_2<TKey, TValue>* dictionary, int32_t getEnumeratorRetType)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { "System.Collections.Generic.Dictionary`2<TKey,TValue>", "System.Int32" });
