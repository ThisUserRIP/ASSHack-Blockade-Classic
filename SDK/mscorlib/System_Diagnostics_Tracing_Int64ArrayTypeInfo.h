...
{
	struct Int64ArrayTypeInfo : mscorlib::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<IL2CPP::Array<mscorlib::System::Int64>>
	{
		...
		void WriteData(mscorlib::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, IL2CPP::Array<int64_t>& value);
		void _ctor();
	};
}
