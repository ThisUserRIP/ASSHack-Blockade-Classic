...
namespace mscorlib::System
{
	template <typename T1, typename T2, typename T3, typename T4, typename T5> struct ValueTuple_5
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			arrayType->vector[4] = mscorlib::System::Type::internal_from_handle((intptr_t)il2cpp_class_get_type(T5::GetIl2CppClass()));
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("mscorlib.dll", "System", "ValueTuple`5")));
		...
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), ".ctor", std::vector<std::string> { GetGenericTypeName<T1>(), GetGenericTypeName<T2>(), GetGenericTypeName<T3>(), GetGenericTypeName<T4>(), GetGenericTypeName<T5>() });
			intptr_t* params = new intptr_t[5];
			params[0] = (intptr_t)item1;
			params[1] = (intptr_t)item2;
			params[2] = (intptr_t)item3;
			params[3] = (intptr_t)item4;
			params[4] = (intptr_t)item5;
		...
		bool Equals(mscorlib::System::ValueTuple_5<T1, T2, T3, T4, T5> other)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Equals", std::vector<std::string> { "System.ValueTuple`5<T1,T2,T3,T4,T5>" });
			intptr_t* params = new intptr_t[1];
		...
		int32_t CompareTo(mscorlib::System::ValueTuple_5<T1, T2, T3, T4, T5> other)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "CompareTo", std::vector<std::string> { "System.ValueTuple`5<T1,T2,T3,T4,T5>" });
			intptr_t* params = new intptr_t[1];
			params[0] = (intptr_t)&other;
			Il2CppException* Il2CppException = nullptr;
			IL2CPP::Il2CppObject* returnValue = il2cpp_runtime_invoke(address, this, (void**)params, &Il2CppException);
