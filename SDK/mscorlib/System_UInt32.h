...
namespace mscorlib::System
{
	struct UInt32
	{
		...
		static uint32_t Parse(mscorlib::System::String* s);
		static uint32_t Parse(mscorlib::System::String* s, mscorlib::System::IFormatProvider* provider);
		static uint32_t Parse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::IFormatProvider* provider);
		static bool TryParse(mscorlib::System::String* s, uint32_t& result);
		static bool TryParse(mscorlib::System::String* s, mscorlib::System::Globalization::NumberStyles style, mscorlib::System::IFormatProvider* provider, uint32_t& result);
