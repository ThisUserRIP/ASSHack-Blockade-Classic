...
namespace Assembly_CSharp_firstpass::RootMotion::FinalIK { struct HitReactionVRIK_PositionOffset_PositionOffsetLink; };
...
{
	struct HitReactionVRIK_PositionOffset : Assembly_CSharp_firstpass::RootMotion::FinalIK::HitReactionVRIK_Offset
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		int32_t forceDirCurveIndex;
		int32_t upDirCurveIndex;
		IL2CPP::Array<Assembly_CSharp_firstpass::RootMotion::FinalIK::HitReactionVRIK_PositionOffset_PositionOffsetLink*>* offsetLinks;
