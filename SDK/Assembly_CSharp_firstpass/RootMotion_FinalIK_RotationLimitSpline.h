...
{
	struct RotationLimitSpline : Assembly_CSharp_firstpass::RootMotion::FinalIK::RotationLimit
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		float twistLimit;
		UnityEngine_CoreModule::UnityEngine::AnimationCurve* spline;
		void OpenUserManual();
		void OpenScriptReference();
		void SupportGroup();
		void ASThread();
		void SetSpline(IL2CPP::Array<UnityEngine_CoreModule::UnityEngine::Keyframe>* keyframes);
