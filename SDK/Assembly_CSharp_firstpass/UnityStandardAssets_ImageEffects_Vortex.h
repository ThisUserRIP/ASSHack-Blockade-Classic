...
{
	struct Vortex : Assembly_CSharp_firstpass::UnityStandardAssets::ImageEffects::ImageEffectBase
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass();
		static mscorlib::System::Type* GetIl2CppType();
		UnityEngine_CoreModule::UnityEngine::Vector2 radius;
		float angle;
		UnityEngine_CoreModule::UnityEngine::Vector2 center;
