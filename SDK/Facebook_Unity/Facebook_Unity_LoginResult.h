...
{
	struct LoginResult : Facebook_Unity::Facebook::Unity::ResultBase
	{
		...
		struct StaticFields
		{
			mscorlib::System::String* UserIdKey;
			mscorlib::System::String* ExpirationTimestampKey;
			mscorlib::System::String* PermissionsKey;
			mscorlib::System::String* AccessTokenKey;
