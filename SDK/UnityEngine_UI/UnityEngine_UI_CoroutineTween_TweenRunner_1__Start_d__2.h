...
{
	template <typename T> struct TweenRunner_1__Start_d__2 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIl2CppNestedType(UnityEngine_UI::UnityEngine::UI::CoroutineTween::TweenRunner_1<T>::GetIl2CppClass(), "<Start>d__2")));
