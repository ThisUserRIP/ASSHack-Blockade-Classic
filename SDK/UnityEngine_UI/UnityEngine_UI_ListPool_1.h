...
namespace UnityEngine_UI::UnityEngine::UI
{
	template <typename T> struct ListPool_1 : mscorlib::System::Object
	{
		static IL2CPP::Il2CppClass* GetIl2CppClass()
		{
			...
			intptr_t handle = ((intptr_t)il2cpp_class_get_type(GetIL2CppClass("UnityEngine.UI.dll", "UnityEngine.UI", "ListPool`1")));
		...
		struct StaticFields
		{
			UnityEngine_UI::UnityEngine::UI::ObjectPool_1<mscorlib::System::Collections::Generic::List_1<T>>* s_ListPool;
		};
		static StaticFields* GetStaticFields() { return reinterpret_cast<StaticFields*>(GetIl2CppClass()->static_fields); }
		static void Clear(mscorlib::System::Collections::Generic::List_1<T>* l)
		{
			static const IL2CPP::MethodInfo* address = GetIl2CppMethod(GetIl2CppClass(), "Clear", std::vector<std::string> { "System.Collections.Generic.List`1<T>" });
