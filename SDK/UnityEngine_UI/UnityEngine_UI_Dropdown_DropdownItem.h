...
{
	struct Dropdown_DropdownItem : UnityEngine_CoreModule::UnityEngine::MonoBehaviour
	{
		...
		UnityEngine_UI::UnityEngine::UI::Text* get_text();
		void set_text(UnityEngine_UI::UnityEngine::UI::Text* value);
